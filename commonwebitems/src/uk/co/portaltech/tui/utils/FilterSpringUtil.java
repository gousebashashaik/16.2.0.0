 ...
 */
public final class FilterSpringUtil
{

   private static final TUILogUtils LOG = new TUILogUtils("FilterSpringUtil");
   ...
   /**
    * Returns the Spring bean with name <code>beanName</code> and of type <code>beanClass</code>. If
    * no bean could be resolved for the specified name, the bean is looked up using type.
    *
    * @param <T> type of the bean
    * @param httpRequest the http request
    * @param beanName name of the bean or <code>null</code> if it should be automatically resolved
    *           using type
   ...
   /**
    * The same as {@link #getSpringBean(HttpServletRequest, String, Class)} but uses ServletContext
    * as the first parameter. It might be used in places, where HttpServletRequest is not available,
    * but ServletContext is.
    */
