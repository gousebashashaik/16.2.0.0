 ...
 *
 */
package uk.co.portaltech.tui.cr.facades;
...
public interface AnalyticsFacade
{
    ...
    List<WebAnalytics> createCustomerAnalyticsData(List<Object> analyticModel, List<AnalyticsParamsModel> analyticOrders,
            String pageId, String userStatus);
