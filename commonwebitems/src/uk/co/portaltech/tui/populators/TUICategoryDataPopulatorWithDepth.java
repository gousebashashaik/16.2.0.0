 ...
 *
 */
public class TUICategoryDataPopulatorWithDepth
        implements
            RecursivePopulator<CategoryModel, TUICategoryData> {
    ...
    public void populate(final CategoryModel sourceModel,
            final TUICategoryData targetData, final int currDepth,
            final int depthToFetch) throws ConversionException {
        int currentDepth = currDepth;
        ...
        if (!LocationType.CONTINENT.getCode().equals(
                ...
                && !"FC".equalsIgnoreCase(tuiUtilityService.getSiteBrand())) {
        ...
        if (CollectionUtils.isNotEmpty(subcategories)
            ...
            for (final CategoryModel subCategoryModel : filteredLocations) {
                ...
                populate(subCategoryModel, tuiCategoryData, currentDepth,
                        depthToFetch);
