 ...
 *
 */
public class AccommodationGettingAroundEditorialPopulator implements Populator<AccommodationModel, AccommodationViewData>
{
    @Resource
    ...
    public void populate(final AccommodationModel sourceModel, final AccommodationViewData targetData) throws ConversionException
    {
        ...
        { "gettingAroundOverview" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
