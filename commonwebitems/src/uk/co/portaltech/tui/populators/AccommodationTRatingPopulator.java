 ...
 *
 */
public class AccommodationTRatingPopulator implements Populator<AccommodationModel, AccommodationViewData>
{
    ...
    public void populate(final AccommodationModel sourceModel, final AccommodationViewData targetData) throws ConversionException
    {
        ...
        { "tRating" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
