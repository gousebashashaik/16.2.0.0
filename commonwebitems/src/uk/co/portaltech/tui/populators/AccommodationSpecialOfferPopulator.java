...
public class AccommodationSpecialOfferPopulator implements Populator<AccommodationModel, AccommodationViewData>
{
    ...
    public void populate(final AccommodationModel sourceModel, final AccommodationViewData targetData) throws ConversionException
    {
        ...
        { "specialOffer" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
