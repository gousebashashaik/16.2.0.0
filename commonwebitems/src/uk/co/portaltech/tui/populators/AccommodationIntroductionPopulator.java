 ...
 *
 */
public class AccommodationIntroductionPopulator implements Populator<AccommodationModel, AccommodationViewData>
{
    ...
    public void populate(final AccommodationModel sourceModel, final AccommodationViewData targetData) throws ConversionException
    {
        ...
        { "introduction" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
