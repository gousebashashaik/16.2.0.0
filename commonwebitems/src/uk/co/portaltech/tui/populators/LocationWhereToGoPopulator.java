 ...
 *
 */
public class LocationWhereToGoPopulator implements Populator<LocationModel, LocationData>
{
    ...
    public void populate(final LocationModel sourceModel, final LocationData targetData) throws ConversionException
    {
        ...
        { "whereToGo" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
