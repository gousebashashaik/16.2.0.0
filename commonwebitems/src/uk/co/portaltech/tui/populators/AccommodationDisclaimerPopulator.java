 ...
 *
 */
public class AccommodationDisclaimerPopulator implements Populator<AccommodationModel, AccommodationViewData>
{
    ...
    public void populate(final AccommodationModel sourceModel, final AccommodationViewData targetData) throws ConversionException
    {
        ...
        { "pleaseNote" }), sourceModel, new Date(), brandUtils.getFeatureServiceBrand(sourceModel.getBrands())));
