 ...
 * 
 * $RCSfile: FCIntrasiteNavigationService.java$
 * 
 * $Revision: $
 * 
 * $Date: 20 Apr 2015$
...
/**
 * @author EXTAP2
 * @description Firstchoice specific implementation of IntrasiteNavigationService.
 */
public class FCIntrasiteNavigationService implements IntrasiteNavigationService
{
   ...
   public IntrasiteNavigation getIntraSiteNavigation(final Object... sources)
   {
      ...
      intrasiteNavigation.setSite(BrandType.FC.toString());
      return intrasiteNavigation;
   }
