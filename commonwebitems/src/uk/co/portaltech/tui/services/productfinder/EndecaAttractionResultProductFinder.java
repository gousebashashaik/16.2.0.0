...
public final class EndecaAttractionResultProductFinder extends AbstractEndecaFinder implements
   ProductFinder
{

   private static final TUILogUtils LOG = new TUILogUtils("EndecaAttractionResultProductFinder");
   ...
   public SearchResultData<ResultData> search(final SearchRequestData request)
   {
      ...
      final AttractionResultPaneComponentModel component =
         (AttractionResultPaneComponentModel) request.getRelevantItem();
