...
public final class ThingsToDoProductFinder extends AbstractEndecaFinder implements ProductFinder
{

   private static final TUILogUtils LOG = new TUILogUtils("ThingsToDoProductFinder");
   ...
   public SearchResultData<ResultData> search(final SearchRequestData request)
   {
      ...
      final ThingsToDoCarouselModel carouselModel =
         (ThingsToDoCarouselModel) request.getRelevantItem();
