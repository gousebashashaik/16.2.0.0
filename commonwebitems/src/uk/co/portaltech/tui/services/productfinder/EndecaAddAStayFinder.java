 ...
 *
 */
public class EndecaAddAStayFinder extends AbstractEndecaFinder implements ProductFinder
{



    private static final TUILogUtils LOG = new TUILogUtils("EndecaAddAStayFinder");
    ...
    {
        LOG.debug("Searching for Endeca Add A Stay Finder.");

        final PlacesToStayCarouselModel carouselModel = (PlacesToStayCarouselModel) request.getRelevantItem();
