 ...
 *
 */
public class EndecaPlacesToStayLocationFinder extends AbstractEndecaFinder implements ProductFinder
{

   private static final TUILogUtils LOG = new TUILogUtils("EndecaPlacesToStayLocationFinder");
   ...
   public SearchResultData<ResultData> search(final SearchRequestData request)
   {
      ...
      LOG.debug("Searching endeca locations result.");
