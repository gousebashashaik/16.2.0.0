...
public final class EndecaDealsProductFinder extends AbstractEndecaFinder implements ProductFinder
{

   private static final TUILogUtils LOG = new TUILogUtils("EndecaDealsProductFinder");

   @Override
   // @Cacheable(cacheName = "endecaBrowseCache")
   public SearchResultData<ResultData> search(final SearchRequestData request)
   {
      LOG.debug("Searching for endeca deals.");
      final DealsComponentModel component = (DealsComponentModel) request.getRelevantItem();
