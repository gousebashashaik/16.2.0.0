 ...
 *
 */
package uk.co.portaltech.tui.th.facades.impl;
...
import uk.co.portaltech.tui.th.facades.AnalyticsFacade;
...
public class DefaultAnalyticFacade implements AnalyticsFacade
{
   ...
   @Resource
   private Populator<Object, Map<String, WebAnalytics>> thBookFlowAnalyticsPopulator;
   ...
   private static final String LAPLAND_ACCOM_OVERVIEW_PAGE =
      "bookFlowLaplandAccommodationOverviewPage";

   private static final String ACCOM_OVERVIEW_LAPLAND = "bookFlowAccommodationOverviewPage_Lapland";
   ...
   private static final String DISPLAY_BOOKING_PAGE = "customerManageDisplayBookingPage";

   private static final String MANAGE_PAYMENT_CONFIRMATION_PAGE = "managePaymentConfirmationPage";
      ...
      final List<AnalyticsParamsModel> analyticOrders, final String page)
   {
      ...
      if (CollectionUtils.isNotEmpty(analyticModel))
      {
         ...
         for (final Object model : analyticModel)
         {
            ...
            else if (accomodationPageCheck(page)
            ...
            {
               thBookFlowAnalyticsPopulator.populate(model, analyticMap);
            }
   ...
   private boolean accomodationPageCheck(final String page)
   {
      return StringUtils.equalsIgnoreCase(page, ACCOMODATION_PAGE)
         ...
         || StringUtils.equalsIgnoreCase(page, VILLA_ACCOMODATION_PAGE) || verifyLaplandAccom(page);
   }

   private boolean verifyLaplandAccom(final String page)
   {
      return StringUtils.equalsIgnoreCase(page, LAPLAND_ACCOM_OVERVIEW_PAGE)
         || StringUtils.equalsIgnoreCase(page, ACCOM_OVERVIEW_LAPLAND);
   }
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.portaltech.tui.facades.AnalyticsFacade#createCustomerAnalyticsData (java.util.List,
