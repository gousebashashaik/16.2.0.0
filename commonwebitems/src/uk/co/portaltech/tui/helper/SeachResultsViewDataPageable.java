...
class SeachResultsViewDataPageable
{
    ...
    private final List<SearchResultViewData> list;
     ...
     *           a List
     */
    SeachResultsViewDataPageable(final List<SearchResultViewData> list, final int offset)
    {
        this.list = list;
        this.page = 1;
        this.maxPages = 1;
     ...
     * @return the page number
     */
    public boolean validateEndIndex(final int endingIndex)
    {
