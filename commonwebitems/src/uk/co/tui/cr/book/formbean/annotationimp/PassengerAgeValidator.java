...
public final class PassengerAgeValidator
{
     ...
     * @param formBean
     *           the form bean
     * @param flightArrivalDate
     *           the flight arrival date
     */
    public static void validateAge(final PassengerDetailsFormBean formBean, final Date flightArrivalDate,
    ...
    private static Date getDateOfBirth(final PassengerInfoFormBean passengerInfoFormBean)
    {
        ...
        {
            return DateUtils.toUtilDate(passengerInfoFormBean.getDay(), passengerInfoFormBean.getMonth(),
    ...
    {
        return StringUtils.equals(PersonType.CHILD.getCode(), paxType) || StringUtils.equals(PersonType.INFANT.getCode(), paxType);
    }
}
