...
public class FormatValidator
        implements
            ConstraintValidator<ValidateFormat, String> {
    ...
    public boolean isValid(final String field,
        ...
        if (empty(field)) {
            ...
            context.buildConstraintViolationWithTemplate(
                    createMessageCode(PassengerDetailConstants.NOT_EMPTY_CODE,
     ...
     * @return the string
     */
    public String createMessageCode(final String errorCode,
