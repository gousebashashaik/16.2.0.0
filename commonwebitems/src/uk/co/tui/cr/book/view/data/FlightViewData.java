...
public class FlightViewData
{
    ...
    */
   public boolean isRepositionalCruise()
   {
      return repositionalCruise;
   }

   /**
    * Sets the repositional cruise.
    *
    * @param repositionalCruise the new repositional cruise
    */
   public void setRepositionalCruise(final boolean repositionalCruise)
   {
