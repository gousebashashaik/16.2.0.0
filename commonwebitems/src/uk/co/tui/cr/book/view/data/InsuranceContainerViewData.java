...
public class InsuranceContainerViewData {
    ...
    /**
     * @param insPasViewData
     *            the insPasViewData to set
     */
    public void setInsPasViewData(
    ...
    /**
     * @param insViewData
     *            the insViewData to set
     */
    public void setInsViewData(final List<InsuranceViewData> insViewData) {
    ...
    /**
     * @param insCriteria
     *            the insCriteria to set
     */
    public void setInsCriteria(final List<InsuranceCriteria> insCriteria) {
    ...
    /**
     * @param coveredAllPassenger
     *            the coveredAllPassenger to set
     */
    public void setCoveredAllPassenger(final boolean coveredAllPassenger) {
    ...
    /**
     * @param overAgeMessage
     *            the overAgeMessage to set
     */
