...
public class ExtraFacilityViewDataContainer
{
   ...
   /** Holds the Class Act Workshop options. */
   private ExtraFacilityCategoryViewData workshopOptions;

   /** Holds the Stage School options. */
   private ExtraFacilityCategoryViewData stageSchool;
    ...
    *
    * @param seatOptions the seatOptions to set
    */
    ...
    *
    * @param baggageOptions the baggageOptions to set
    */
   public void setBaggageOptions(final ExtraFacilityCategoryViewData baggageOptions)
   {
    ...
    *
    * @param mealOptions the mealOptions to set
    */
    ...
    *
    * @param lateCheckOut the lateCheckOut to set
    */
   ...
   /**
    * @param donationOptions the donationOptions to set
    */
   public void setDonationOptions(final ExtraFacilityCategoryViewData donationOptions)
   {
    ...
    *
    * @param transferOptions the transferOptions to set
    */
   public void setTransferOptions(final ExtraFacilityCategoryViewData transferOptions)
   {
    ...
    */
   public void setInfantOptions(final ExtraFacilityCategoryViewData infantOptions)
   {
      this.infantOptions = infantOptions;
   }

   /**
    * Gets the workshop options
    */
   public ExtraFacilityCategoryViewData getWorkshopOptions()
   {
      if (this.workshopOptions == null)
      {
         this.workshopOptions = new ExtraFacilityCategoryViewData();
      }
      return workshopOptions;
   }

   /**
    * Sets the workshop options
    */
   public void setWorkshopOptions(final ExtraFacilityCategoryViewData workshopOptions)
   {
      this.workshopOptions = workshopOptions;
   }

   /**
    * @return the stageSchool
    */
   public ExtraFacilityCategoryViewData getStageSchool()
   {

      if (this.stageSchool == null)
      {
         this.stageSchool = new ExtraFacilityCategoryViewData();
      }
      return stageSchool;
   }

   /**
    * @param stageSchool the stageSchool to set
    */
   public void setStageSchool(final ExtraFacilityCategoryViewData stageSchool)
   {
      this.stageSchool = stageSchool;
   }
   ...
   /**
    * @param stageOptions the stageOptions to set
    */
   public void setStageOptions(final ExtraFacilityCategoryViewData stageOptions)
   {
   ...
   /**
    * @param swimOptions the swimOptions to set
    */
   public void setSwimOptions(final ExtraFacilityCategoryViewData swimOptions)
   {
   ...
   /**
    * @param crecheOptions the crecheOptions to set
    */
   public void setCrecheOptions(final ExtraFacilityCategoryViewData crecheOptions)
   {
   ...
   /**
    * @param soccerOptions the soccerOptions to set
    */
   public void setSoccerOptions(final ExtraFacilityCategoryViewData soccerOptions)
   {
   ...
   /**
    * @param excursionOptions the excursionOptions to set
    */
   public void setExcursionOptions(final List<ExtraFacilityCategoryViewData> excursionOptions)
   {
   ...
   /**
    * @param carHireUpgrade the carHireUpgrade to set
    */
   public void setCarHireUpgrade(final List<ExtraFacilityCategoryViewData> carHireUpgrade)
   {
   ...
   /**
    * @param carHireExtras the carHireExtras to set
    */
   public void setCarHireExtras(final ExtraFacilityCategoryViewData carHireExtras)
   {
