package uk.co.tui.cr.book.converters;
...
{
    public static final PackageOption CRUISEITINERARY = new PackageOption("CRUISEITINERARY");
    ...
    public static final PackageOption STAY = new PackageOption("STAY");
    ...
    public static final PackageOption LAPLAND = new PackageOption("LAPLAND");
    public static final PackageOption MULTI_CENTRE = new PackageOption("MULTI_CENTRE");
    private static final PackageOption CRUISE_FLIGHT = new PackageOption("CRUISE_FLIGHT");

    private static List<PackageOption> internalValues = Arrays.asList(FLIGHT, PRICE_BREAKDOWN, STAY, PAX_COMPOSITION,
            MEMO, PRICE, LAPLAND, MULTI_CENTRE, CRUISE_FLIGHT);
    ...
    public static PackageOption valueOf(final String option)
    {
        ...
        {
            throw new IllegalArgumentException("Cannot parse into an element of " + PackageOption.class.getSimpleName() + ": '"
                    + option + "'");
        }
    }
