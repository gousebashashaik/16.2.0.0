 ...
 *
 */
public class RoomStaticContentViewDataPopulator
        implements
            Populator<Object, RoomOptionsStaticContentViewData> {
    ...
    private void populateRoomContent(
        ...
        roomViewData.setRoomContentMap(staticContentServ.getRoomContents());
    ...
    public void populate(final Object source,
            final RoomOptionsStaticContentViewData target)
