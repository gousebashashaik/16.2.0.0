 ...
 */
public class OccupancyViewDataPopulator
        implements
            Populator<Occupancy, OccupancyViewData> {
     ...
     */
    @Override
    public void populate(final Occupancy roomOccupancy,
            final OccupancyViewData occupancyViewData) {
