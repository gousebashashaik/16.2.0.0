 ...
 *
 */
public class PrivacyPolicyContentViewDataPopulator implements Populator<Object, TermsAndConditionsViewData>
{
     ...
     */
    @Override
    public void populate(final Object source, final TermsAndConditionsViewData target) throws ConversionException
    {
        ...
        for (final String code : privacyPolicyList)
        {
            ...
            {
                target.getPrivacyPolicyMap().putAll(genericContentService.getGenericDynamicContentValue(dynamicContent));
            }
        }
    }
