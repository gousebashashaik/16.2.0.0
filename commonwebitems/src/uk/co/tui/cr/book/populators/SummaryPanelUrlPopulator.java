...
import uk.co.tui.cr.book.view.data.SummaryPanelComponentViewData;
import uk.co.tui.cr.book.view.data.SummaryPanelUrlsViewData;
...
public class SummaryPanelUrlPopulator implements Populator<String, SummaryPanelViewData>
{
      ...
      throws ConversionException
   {
      ...
      getPageUrls(brand, httpBaseURL, pageNames, urlMap);
    ...
    * @param urlMap
    */
   private void getPageUrls(final String brand, final String httpBaseURL,
      final List<String> pageNames, final Map<String, String> urlMap)
   {
      for (final String page : pageNames)
      {
         obtainUrls(brand, httpBaseURL, urlMap, page);
      }
   }
    ...
    * @param page
    */
   private void obtainUrls(final String brand, final String httpBaseURL,
      final Map<String, String> urlMap, final String page)
   {
      String url =
      ...
      if ("HR".equals(page))
      {
         url =
            StringUtil.append(httpBaseURL,
               (String) sessionService.getAttribute(SessionObjectKeys.HOTEL_RESULTS_URL));
      }
