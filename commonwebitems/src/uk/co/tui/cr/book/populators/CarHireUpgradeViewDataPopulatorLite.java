...
import uk.co.tui.cr.book.view.data.CarHireExtraFacilityViewData;
...
public class CarHireUpgradeViewDataPopulatorLite
    ...
    private String populateCurrencyAppendedPrice(
        ...
        return getCurrencyAppendedPrice(
                carUpgradePrice.subtract(selectedCarPrice),
     ...
     */
    private static String getCurrencyAppendedPrice(final BigDecimal price,
            final String currencyCode) {
        String formattedPrice = StringUtils.EMPTY;
        if (price.compareTo(BigDecimal.ZERO) < 0) {
            formattedPrice = StringUtil.append("-",
    ...
    private String populateCurrencyAppendedPricePerDay(
        ...
        return getCurrencyAppendedPrice(perdayPrice,
                currencyResolver.getSiteCurrency());
    }
