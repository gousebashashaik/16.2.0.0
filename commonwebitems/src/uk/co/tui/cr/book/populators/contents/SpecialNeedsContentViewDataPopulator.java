 ...
 *
 */
public class SpecialNeedsContentViewDataPopulator implements Populator<Object, TermsAndConditionsViewData>
{
    ...
    public void populate(final Object source, final TermsAndConditionsViewData target) throws ConversionException
    {
        ...
        for (final String code : specialNeedsList)
        {
            ...
            {
                target.getSpecialNeedsMap().putAll(genericContentService.getGenericDynamicContentValue(dynamicContent));
            }
        }
    }
}
