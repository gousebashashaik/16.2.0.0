...
public interface FlightExtraFacilityFacade {
     ...
     */
    FlightOptionsViewData updateProductForBaggageExtras(
     ...
     * @return FlightOptionsViewData
     */
    FlightOptionsViewData updateProductForMealExtras(
            Map<String, String> mealAllocationMap);

    /**
     * @param packageModel
     * @param viewData
     */
    void populatePackageView(final BasePackage packageModel,
            final FlightOptionsViewData viewData);

    /**
     * @param viewData
     */
    void populateFlightOptionsStaticContentViewData(
            final FlightOptionsViewData viewData);

    /**
     * @param selectedPackage
     */
    void updateBaggageForPremiumSeat(BasePackage selectedPackage,
