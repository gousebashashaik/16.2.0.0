...
public interface PackageExtraFacilityFacade {
     ...
     */
    RoomAndBoardOptionsPageViewData updateProductForLateCheckOut(
            String extraCategory, String extraCode, String quantity);
     ...
     */
    ExtraOptionsViewData updateProductForInfantOptions(
            List<InfantActivityCriteria> infantExtraCriteria);
     ...
     */
    ExtraOptionsViewData updateProductForSwimActivity(
            List<KidsActivityCriteria> data);
    /**
     ...
     * @return ExtraOptionsViewData
     */
    ExtraOptionsViewData updateProductForKidsActivity(
            List<KidsActivityCriteria> data);
     ...
     * @return ExtraOptionsViewData
     */
    ExtraOptionsViewData updateProductForExcursions(
            List<AncillaryCriteria> criteria);
     ...
     * @return ExtraOptionsViewData
     */
    ExtraOptionsViewData updateProductForAttractions(
            List<AncillaryCriteria> criteria);
    ...
    void renderExtrasStore();

    /**
     * @param containerViewData
     */
    void sortExtraFacilityCategoriesInAddedOrder(
            ExtraFacilityViewDataContainer containerViewData);
     ...
     * @param categoryMap
     */
    void getCategoryModelFromStore(
            PackageExtraFacilityStore packageExtraFacilityStore,
            ExtraFacilityViewDataContainer containerViewData,
            List<String> kidsActivityCategoryList,
            Map<String, ExtraFacilityCategoryViewData> categoryMap);

    /**
     * @param extraCode
     * @param packageModel
     */
    void updateExtraFacilityQuantity(String extraCode, BasePackage packageModel);
     ...
     * @param packageModel
     */
    void updateKidsAcitivityExtrasLite(MultiValueMap extraPassengerMapping,
            List<KidsActivityCriteria> criteria, BasePackage packageModel);
     ...
     */
    void getExtraFacilityFromEachSelectedLite(BasePackage packageModel,
            Entry<List<ExtraFacility>, List<String>> eachExtraEntry,
            ExtraFacility eachSelectedExtra);

    /**
     * @param infantExtraCategoryCode
     * @param infantExtraCode
     */
    void removeInfantEquipment(String infantExtraCategoryCode,
            String infantExtraCode);
     ...
     */
    ExtraFacility fetchExtraFacilityFromPackageExtraStoreLite(String packageId,
            String extraCategoryCode, String extraFacilityCode);

    /**
     * @param extraCode
     * @param extra
     */
    void updateExtraFacilitySelectedQuantityForChild(String extraCode,
            ExtraFacility extra);
