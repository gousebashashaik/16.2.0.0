...
import uk.co.tui.cr.book.facade.PromoComponentFacade;
...
public class DefaultPromoComponentFacade implements PromoComponentFacade
{
    ...
    @Resource
    private PackageViewDataPopulator crPackageViewDataPopulator;
    ...
    @Resource
    private Populator<Object, PassengerDetailsStaticContentViewData> crPassengerStaticContentViewDataPopulator;
    ...
    private void populatePassengerStaticContentViewData(final PassengerDetailsViewData viewData)
    {
        ...
        crPassengerStaticContentViewDataPopulator.populate(new Object(), passengerDetailsStaticContentViewData);
    ...
    public PassengerDetailsViewData removeExistingPromoCode()
    {
        ...
        crPackageViewDataPopulator.populate(packageModel, passengerDetailsViewData.getPackageViewData());
