...
import static uk.co.tui.cr.book.constants.BookFlowConstants.EMPTY;
import static uk.co.tui.cr.book.constants.BookFlowConstants.EXTRAOPTIONS;
...
import uk.co.tui.cr.book.data.AncillaryCriteria;
import uk.co.tui.cr.book.data.InfantActivityCriteria;
...
import uk.co.tui.cr.book.populators.CarHireUpgradeViewDataPopulatorLite;
import uk.co.tui.cr.book.populators.ExtraFacilityViewDataPopulatorLite;
import uk.co.tui.cr.book.populators.PackageExtrasContainerPopulator;
import uk.co.tui.cr.book.populators.PackageViewDataPopulator;
import uk.co.tui.cr.book.populators.PassengerViewDataPopulator;
import uk.co.tui.cr.book.populators.RoomExtrasContainerPopulator;
import uk.co.tui.cr.book.populators.SelectedCarHireViewDataPopulator;
import uk.co.tui.cr.book.populators.SummaryPanelUrlPopulator;
import uk.co.tui.cr.book.store.CarHireUpgradeExtraFacilityStore;
...
import uk.co.tui.cr.book.view.data.ExtraOptionsContentViewData;
import uk.co.tui.cr.book.view.data.ExtraOptionsStaticContentViewData;
...
import uk.co.tui.cr.util.ExtraFacilityStoreUtils;
...
public class PackageExtraFacilityFacadeImpl implements PackageExtraFacilityFacade
{
   ...
   /** The package extras service lite. */
   @Resource
   ...
   /** The room extras container populator. */
   @Resource(name = "crRoomExtrasContainerPopulator")
   private RoomExtrasContainerPopulator roomExtrasContainerPopulator;
   
   /** The package extras container populator. */
   @Resource(name = "crPackageExtrasContainerPopulator")
   ...
   @Resource(name = "crExtraStaticContentViewDataPopulator")
   ...
   @Resource(name = "crExtraOptionsContentViewDataPopulator")
   private Populator<Object, ContentViewData> extraOptionsContentViewDataPopulator;
   
   @Resource(name = "crCarHireUpgradeViewDataPopulatorLite")
   ...
   /** The extra facility strore util. */
   @Resource(name = "crExtraFacilityStroreUtil")
   private ExtraFacilityStoreUtils extraFacilityStroreUtil;
   
   /** The Constant BOXING. */
   private static final String BOXING = "boxing";
   
   /** The book flow tui config service. */
   @Resource
   ...
   /** The selected car hire view data populator. */
   @Resource(name = "crSelectedCarHireViewDataPopulator")
   ...
   public void renderPackageExtras(final ExtraOptionsViewData extraOptionsViewData)
   {
      ...
      final PackageExtraFacilityStore extraFacilityStore =
         sessionService.getAttribute(SessionObjectKeys.PACKAGE_EXTRA_FACILITY_STORE);
      List<ExtraFacilityCategory> storeExtraCategories =
         extraFacilityStroreUtil.getPackageExtrasFromStoreLite(packageModel.getId());
      if (extraFacilityStore != null && extraFacilityStore.isCruiseExtraSet())
      {
         storeExtraCategories = null;
      }
      if (CollectionUtils.isEmpty(storeExtraCategories))
      {
         final PackageExtraFacilityResponse packageExtraFacilityResponse =
            getPackageExtras(ExtraFacilityGroup.PACKAGE);
         ...
         sessionService.setAttribute(SessionObjectKeys.PACKAGE_EXTRA_FACILITY_STORE,
            packageExtraFacilityStore);
      }
   ...
   /**
    * Gets the package extras.
    *
    * @return PackageExtraFacilityResponse
    */
   private PackageExtraFacilityResponse getPackageExtras(final ExtraFacilityGroup extraFacilityGroup)
   {
      PackageExtraFacilityResponse packageExtraFacilityResponse;
      try
      {
         packageExtraFacilityResponse =
            packageExtrasServiceLite.getPackageExtras(getPackageModel(), extraFacilityGroup);
      }
   ...
   /**
    * Gets the cruise extras.
    *
    * @return PackageExtraFacilityResponse
    */
   private PackageExtraFacilityResponse getCruiseExtras(final ExtraFacilityGroup extraFacilityGroup)
   {
      PackageExtraFacilityResponse packageExtraFacilityResponse;
      try
      {
   ...
   /**
    * Checks if is item search required.
    *
    * @return true, if is item search required
    */
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.tui.cr.book.facade.PackageExtraFacilityFacade#
    * updateProductForDonationOptions(java.lang.String, java.lang.String)
    */
   @Override
    ...
    * @param packageModel the package model
    * @param extraOptionsViewData the extra options view data
    * @return the default car hire upgrade view data
    */
   ...
   /**
    * Process each infant activity lite.
    *
    * @param packageModel the package model
    * @param extraOptionsViewData the extra options view data
    * @param exFacSelectionComposition the ex fac selection composition
    * @param infantExtra the infant extra
    */
      ...
      final InfantActivityCriteria infantExtra)
   {
      ...
      if (selectedExtraFacility != null)
      {
         exFacSelectionComposition.put(
            ...
            PassengerUtils.getPassengersIdWithAgeRang(Integer.valueOf(BookFlowConstants.ZERO),
    ...
    */
   @Override
   public void removeInfantEquipment(final String infantExtraCategoryCode,
   ...
   /**
    * Adds the infant equipment lite.
    *
    * @param packageModel the package model
    * @param exFacSelectionComposition the ex fac selection composition
    */
   ...
   /**
    * Gets the extra facility from each selected lite.
    *
    * @param packageModel the package model
    * @param eachExtraEntry the each extra entry
    * @param eachSelectedExtra the each selected extra
    * @return the extra facility from each selected lite
    */
   @Override
   public void getExtraFacilityFromEachSelectedLite(final BasePackage packageModel,
      ...
      final ExtraFacility eachSelectedExtra, final ExtraFacility extraFacilityModel)
   {
         ...
         eachSelectedExtra.getExtraFacilityCode()))
      {
         extraFacilityQuantityCalculationService.updateExtraFacilitySelectedQuantity(
            extraFacilityModel, eachExtraEntry.getValue().size());
      }
   }
   ...
   {
      summaryPanelUrlPopulator.populate(BookFlowConstants.ROOMOPTIONS,
    ...
    */
   @Override
   public ExtraFacility fetchExtraFacilityFromPackageExtraStoreLite(final String packageId,
   ...
   /**
    * Gets the extra from category lite.
    *
    * @param extraFacilityCode the extra facility code
    * @param exFacilityCategory the ex facility category
    * @return the extra from category lite
    */
   ...
   public void populateExtraOptionsAllView(final BasePackage packageModel,
      final ExtraOptionsViewData extraOptionsViewData)
   {
      extraOptionsViewData.setPackageType(getPackageModel().getPackageType().toString());
    ...
    */
   @Override
   public void populateRoomOptionsAllView(final BasePackage packageModel,
      ...
      if (extraOptionsViewData.getInsuranceContainerViewData() == null)
      {
         extraOptionsViewData
            .setInsuranceContainerViewData((InsuranceContainerViewData) sessionService
               .getAttribute(SessionObjectKeys.INSURANCE_CONTAINER_VIEW_DATA));
      }
   }
   
   /**
    * Process if infant options not null.
    *
   ...
   /**
    * Gets the category model from store.
    *
    * @param packageExtraFacilityStore the package extra facility store
    * @param containerViewData the container view data
    * @param kidsActivityCategoryList the kids activity category list
    * @param categoryMap the category map
    */
   @Override
   public void getCategoryModelFromStore(final PackageExtraFacilityStore packageExtraFacilityStore,
      final ExtraFacilityViewDataContainer containerViewData,
      final List<String> kidsActivityCategoryList,
      final Map<String, ExtraFacilityCategoryViewData> categoryMap)
   {
    ...
    */
   @Override
   public void sortExtraFacilityCategoriesInAddedOrder(
      final ExtraFacilityViewDataContainer containerViewData)
   {
    ...
    *
    * @param minAdultCountRequiredForExtra the min adult count required for extra
   ...
   /**
    * Gets the entry set from extras to passenger map lite.
    *
    * @param categoryViewData the category view data
    * @param extrasToPassengerMap the extras to passenger map
    * @return the entry set from extras to passenger map lite
    */
   ...
   /**
    * Flag swim or stage extra selected.
    *
    * @param passengerModel the passenger model
    * @param passengerViewData the passenger view data
    */
   ...
   /**
    * Update extra facility service for kids activity.
    *
    * @param criteria the criteria
    * @param packageModel the package model
    * @param exFacSelectionComposition the ex fac selection composition
    ...
    */
   @Override
   public void updateExtraFacilityQuantity(final String extraCode, final BasePackage packageModel)
   {
      final List<String> kidsActivityCategoryList =
         extraFacilityUpdator.getKidsActivityCriteriaList();
   ...
   /**
    * Update excursion or attraction.
    *
    * @param extraCode the extra code
   ...
   /**
    * Iterate category model for excursion or attraction.
    *
    * @param extraCode the extra code
    * @param categoryModel the category model
    */
    ...
    */
   @Override
   public void updateExtraFacilitySelectedQuantityForChild(final String extraCode,
   ...
   /**
    * Iterate category model for swim extra.
    *
    * @param quantity the quantity
    * @param extraCode the extra code
    * @param passenger the passenger
   ...
   /**
    * Update store transfer extras lite.
    *
    * @param transferCode the transfer code
    * @param resetFreeTransferOption the reset free transfer option
    */
   ...
   /**
    * Iterate extra facility category for transfer lite.
    *
    * @param transferCode the transfer code
    * @param exFacilityCategory the ex facility category
    * @param resetFreeTransferOption the reset free transfer option
   ...
   /**
    * Update selected car hire to view data.
    *
    * @param packageModel the package model
   ...
   /**
    * Null check for car hire upgrade or extra facility.
    *
    * @param packageModel the package model
    * @param carHireUpgradeExtraFacilityStore the car hire upgrade extra facility store
    * @return boolean
    */
   ...
   /**
    * Checks if is valid depot details.
    *
    * @param swappedExtra the swapped extra
    * @return depot details
    */
   ...
   /**
    * Valid basic car hire.
    *
    * @param extraCat the extra cat
    * @return is valid basic car hire
    */
   ...
   public ExtraOptionsViewData updateProductForCarHireUpgradeOptions(final String code)
   {
      ...
      {
         deepCopyCarHire(code, packageModel);
      }
    ...
    * @param packageModel the package model
    */
   private void deepCopyCarHire(final String code, final BasePackage packageModel)
   {
      final ExtraFacility selectExFacility;
   ...
   /**
    * Checks if is car hire transfer.
    *
    * @return true, if is car hire transfer
    */
   ...
   /**
    * Update car hire extra discription.
    */
   ...
   /**
    * Sets the car hire discription.
    *
    * @param category the new car hire discription
    */
   ...
   /**
    * Fetch selected car hire ex facility category lite.
    *
    * @param exFacCode the ex fac code
   ...
   /**
    * Iterate category model for car hire lite.
    *
    * @param exFacCode the ex fac code
    * @param categoryModel the category model
    * @return the extra facility
      ...
      final RoomAndBoardOptionsPageViewData viewData)
   {
      ...
      cabinStaticContentViewDataPopulator.populate(new Object(), roomOptionsStaticContentViewData);
   ...
   /**
    * Iterate extra facility category for default transfer lite.
    *
    * @param packageModel the package model
   ...
   /**
    * Validate extra facility group and car hire.
    *
    * @param extraFacilityCategoryModel the extra facility category model
    * @return boolean
    */
    ...
    *
    * @param transfeOptions the transfe options
    * @param selectedTransferPrice the selected transfer price
    */
   ...
   private void populateRoomOptionsContentViewData(final RoomAndBoardOptionsPageViewData viewData)
   {
      ...
      cabinOptionsContentViewDataPopulator.populate(new Object(), roomContent);
    ...
    *
    * @param packageModel the package model
    * @param selectExFacility the select ex facility
    */
   ...
   /**
    * Update transfer option container.
    *
   ...
   /**
    * Gets the selected transfer extra code.
    *
    * @param packageModel the package model
    * @return the selected transfer extra code
    */
   ...
   /**
    * Update car hire view data container.
    *
    * @param extraFacilityCode the extra facility code
    * @param carHireUpgrade the car hire upgrade
    */
   ...
   /**
    * Update transfer view data container.
    *
    * @param extraFacilityCode the extra facility code
   ...
   /**
    * Update selection type lite.
    *
    * @param selectedExtraFacility the selected extra facility
    * @param isCarHireAvailable the is car hire available
    */
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.tui.cr.book.facade.PackageExtraFacilityFacade#renderCruiseExtras
    * (uk.co.tui.cr.book.view.data.RoomAndBoardOptionsPageViewData)
    */
   @Override
   public void renderExtrasStore()
   {
      final BasePackage packageModel = getPackageModel();
      
      List<ExtraFacilityCategory> storeExtraCategories =
         extraFacilityStroreUtil.getPackageExtrasFromStoreLite(packageModel.getId());
      if (isFlushRequiredForCruiseExtras(packageModel))
      {
         storeExtraCategories = null;
      }
      if (CollectionUtils.isEmpty(storeExtraCategories))
      {
         final PackageExtraFacilityResponse packageExtraFacilityResponse =
            getExtraFacilityResponse(packageModel);
         ...
         {
            packageExtraFacilityStore.setCruiseExtraSet(true);
         }
         sessionService.setAttribute(SessionObjectKeys.PACKAGE_EXTRA_FACILITY_STORE,
            packageExtraFacilityStore);
      }
    ...
    * @return packageExtraFacilityResponse
    */
   private PackageExtraFacilityResponse getExtraFacilityResponse(final BasePackage packageModel)
   {
      PackageExtraFacilityResponse packageExtraFacilityResponse =
         new PackageExtraFacilityResponse();
      if (packageComponentService.isMultiCentre(packageModel))
      {
         packageExtraFacilityResponse = getCruiseExtras(ExtraFacilityGroup.CRUISE);
      }
      else
      {
         packageExtraFacilityResponse = getPackageExtras(ExtraFacilityGroup.PACKAGE);
      }
      return packageExtraFacilityResponse;
   }
    ...
    * @param packageModel
    */
   private boolean isFlushRequiredForCruiseExtras(final BasePackage packageModel)
   {
      final PackageExtraFacilityStore extraFacilityStore =
         sessionService.getAttribute(SessionObjectKeys.PACKAGE_EXTRA_FACILITY_STORE);
      if ((extraFacilityStore != null) && (!extraFacilityStore.isCruiseExtraSet())
         && (packageComponentService.isMultiCentre(packageModel)))
      {
         return true;
   ...
   /**
    * Update kids acitivity extras lite.
    *
    ...
    */
   @Override
   public void updateKidsAcitivityExtrasLite(final MultiValueMap extraPassengerMapping,
      final List<KidsActivityCriteria> criteria, final BasePackage packageModel)
   {
      final Map<List<ExtraFacility>, List<String>> exFacSelectionComposition =
         new HashMap<List<ExtraFacility>, List<String>>();
