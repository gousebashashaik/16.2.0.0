 ...
 * @author amaresh.d
 */
final class ShortlistHolidayDepositComponentPopulator implements
   Populator<ShortlistHolidayData, BasePackage>
{
    ...
    */
   @Override
   public void populate(final ShortlistHolidayData holiday, final BasePackage packageModel)
   {
      ...
      final ShortlistHolidayData holiday)
   {
      ...
      final uk.co.tui.shortlist.data.InventoryInfo tracsDetails = holiday.getInventoryInfo();
