 ...
 *
 */
public class SavedHolidayExtraViewData
{
   /**
   ...
   private SavedHolidayExtrasMapping savedHolidayExtrasMapping;
   ...
   {
      return this.price.setScale(CaViewDataConstants.ALLOWED_DECIMAL_TWO, BigDecimal.ROUND_UP);
   }
    ...
    */
   public SavedHolidayExtrasMapping getPassengerExtraFacilityMapping()
   {
      if (this.savedHolidayExtrasMapping == null)
      {
         this.savedHolidayExtrasMapping = new SavedHolidayExtrasMapping();
      }
      return savedHolidayExtrasMapping;
   }

   /**
    * @param savedHolidayExtrasMapping the savedHolidayExtrasMapping to set
    */
   public void setPassengerExtraFacilityMapping(
      final SavedHolidayExtrasMapping savedHolidayExtrasMapping)
   {
      this.savedHolidayExtrasMapping = savedHolidayExtrasMapping;
   }
