 ...
 *
 */
package uk.co.tui.th.book.url.builders;
      ...
      for (final Leg legModel : outBoundLegList)
      {
         ...
         if (null != legModel.getSchedule())
         {
            ...
            if (StringUtils.isNotEmpty(flightNum))
            {
               ...
               // append carrier name
               flightCode.append(legModel.getCarrier().getCode().trim());
               // append carrier code or flight number
               flightCode.append(flightNum.trim());
