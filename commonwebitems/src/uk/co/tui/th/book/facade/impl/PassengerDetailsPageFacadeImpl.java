...
import uk.co.tui.th.book.facade.PassengerDetailsPageFacade;
import uk.co.tui.th.book.populators.AlertViewDataPopulator;
...
import uk.co.tui.th.book.view.data.DataProtectionViewData;
import uk.co.tui.th.book.view.data.InfantNotYetBornViewData;
import uk.co.tui.th.book.view.data.MemoViewData;
import uk.co.tui.th.book.view.data.PackageViewData;
import uk.co.tui.th.book.view.data.PassengerData;
...
public class PassengerDetailsPageFacadeImpl implements PassengerDetailsPageFacade
{
	...
	@Resource(name = "thDataProtectionViewDataPopulator")
	...
	public List<Feedback> performInfoBook(final BasePackage pkg) throws TUIBusinessException, FlightSoldOutException
	{
		...
		catch (final BookServiceException e)
		{
			...
			{
				throw new uk.co.tui.th.exception.TUIBusinessException(e.getErrorCode(), e.getCustomMessage(), e);
			}
			else
			{
