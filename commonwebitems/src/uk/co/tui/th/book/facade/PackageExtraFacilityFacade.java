...
public interface PackageExtraFacilityFacade
{
    ...
    /**
     * The method to update donation extras to passenger,populate ExtraOptionsAllView,saving the package model after
     * updating
     *
     * @param extraCategory
    ...
    /**
     * Method to remove ExtraCategoryFromPackage if code is empty,update the quantity , calculate price, update the
     * packagemodel Populate AllViews of RoomOptions,saving the package model
     *
     * @param extraCategory
    ...
    /**
     * Method to removeExtraCategoryFromPackage RemoveExtraSuperCategoryFromPackage,update transfer extra facility
     * quantity,calculate price ,update the packagemodel Populate all view,saving the package
     *
     * @param extraCategory
     *           The extra facility categorymodel code
     * @param transferCode
    ...
    /**
     * This method updateProductForInfantOptions this method also Adding InfantEquipments Update the
     * packagemodel,populate all view,saving the package
     *
    ...
    /**
     * This method updates the Stage Academy Extras. Update the package model ,populate all view,saving the package
     *
     * @param data
    ...
    /**
     * Method updates SwimExtra facility Update the package model ,populate all view,saving the package
     *
     * @param data
     *           List of KidsActivityCriteria
     * @return ExtraOptionsViewData
    ...
    /**
     * Method removes product for KidsActivity, Update the package model ,populate all view,saving the package
     *
     * @param data
     *           list of KidsActivityCriteria
     * @return ExtraOptionsViewData
    ...
    /**
     * Method updates product for excursions ,updateAncilliary Update the package model ,populate all view,saving the
     * package
     *
     * @param criteria
    ...
    /**
     * This method update the package model for the attraction Updates ExtraFacility selected quantity for child Update
     * the package model ,populate all view,saving the package
     *
     * @param criteria
     *           the list of AncillaryCriteria
     * @return ExtraOptionsViewData
    ...
    /**
     * Method to updateProductForCarHireUpgradeOptions This method does removal of
     * DefaultTransferCategories,updateStoreTransferExtras,adding selected CarHireExtraFacilty To PackageModel Populate
     * all view,saving the package
     *
     * @param code
    ...
    /**
     * Method to compare two packages This method does removePromotionalCode,swapping the packages,populate alert view
    ...
    /**
     * Method is to populate ExtraOptionsContainerView,ExtraOptionsPackageView, ExtraOptionsSummaryView
     *
     * @param packageModel
     *           Packagemodel
     * @param extraOptionsViewData
     ...
     */
    void renderCruiseExtras(CruiseOptionsViewData cruiseOptionsViewData);
