...
import uk.co.tui.th.book.facade.RoomOptionsPageFacade;
...
import uk.co.tui.th.book.populators.RoomViewDataPopulator;
...
import uk.co.tui.th.book.view.data.RoomOptionsViewData;
...
public class RoomOptionsPageFacadeImpl implements RoomOptionsPageFacade
{
   ...
   @Resource(name = "thRoomViewDataPopulator")
   ...
   @Resource(name = "thOccupancyViewDataPopulator")
   ...
   private static final String WEBANALYTICS = "th_webAnalyticsData";
   
   /** The Constant LAI_WARNING_MESSAGE. */
   private static final String LAI_WARNING_MESSAGE = "th_room_lai_warning_message";
