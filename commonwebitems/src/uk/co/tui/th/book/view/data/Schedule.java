...
public class Schedule {
    ...
    /**
     * @param flightOffsetDays
     *            the flightOffsetDays to set
     */
     ...
     *
     * @param departureDateInMiliSeconds
     *            the departureDateInMiliSeconds to set
     */
    public void setDepartureDateInMiliSeconds(String departureDateInMiliSeconds) {
     ...
     *
     * @param arrivalDateInMiliSeconds
     *            the arrivalDateInMiliSeconds to set
     */
    public void setArrivalDateInMiliSeconds(String arrivalDateInMiliSeconds) {
     ...
     */
    public void setFlightOffsetDaysSummary(String flightOffsetDaysSummary) {
