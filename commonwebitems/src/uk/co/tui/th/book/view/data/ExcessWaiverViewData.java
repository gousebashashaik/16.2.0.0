...
public class ExcessWaiverViewData {
   ...
   /** The price. */
   private String excessWaiverprice = StringUtils.EMPTY;
   ...
   /**
    * @return the excessWaiverprice
    */
   public String getExcessWaiverprice()
   {
      return excessWaiverprice;
   }

   /**
    * @param excessWaiverprice the excessWaiverprice to set
    */
   public void setExcessWaiverprice(final String excessWaiverprice)
   {
      this.excessWaiverprice = excessWaiverprice;
   }
