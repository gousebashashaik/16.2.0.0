...
public class PackageViewData {
     ...
     *
     * @param currencyAppendedPricePerPerson
     *            the currencyAppendedPricePerPerson to set
     */
    public void setCurrencyAppendedPricePerPerson(
            final String currencyAppendedPricePerPerson) {
     ...
     *
     * @param currencyAppendedOnlineDiscount
     *            the currencyAppendedOnlineDiscount to set
     */
    public void setCurrencyAppendedOnlineDiscount(
            final String currencyAppendedOnlineDiscount) {
     ...
     *
     * @param onlineDiscount
     *            the onlineDiscount to set
     */
     ...
     *            the extraFacilityCategoryViewData to set
     */
    public void setExtraFacilityCategoryViewData(
            List<ExtraFacilityCategoryViewData> extraFacilityCategoryViewData) {
     ...
     */
    public void setPassenger(List<PassengerViewData> passenger) {
     ...
     *
     * @param isLaplandDayTrip
     *            the isLaplandDayTrip to set
     */
    public void setLaplandDayTrip(boolean isLaplandDayTrip) {
    ...
    /**
     * @param summaryPanelStaticContentViewData
     *            the summaryPanelStaticContentViewData to set
     */
    public void setSummaryPanelStaticContentViewData(
            SummaryPanelStaticContentViewData summaryPanelStaticContentViewData) {
    ...
    /**
     * @param multicomThirdPartyFlight
     *            the multicomThirdPartyFlight to set
     */
    public void setMulticomThirdPartyFlight(boolean multicomThirdPartyFlight) {
    ...
    /**
     * @param multicomThirdPartyFlightCarrierCode
     *            the multicomThirdPartyFlightCarrierCode to set
     */
    public void setMulticomThirdPartyFlightCarrierCode(
            String multicomThirdPartyFlightCarrierCode) {
     ...
     *
     * @param tracsThirdPartyFlight
     *            the new tracs third party flight
     */
    public void setTracsThirdPartyFlight(boolean tracsThirdPartyFlight) {
     ...
     */
    public void setAccomViewData(List<AccommodationViewData> accomViewData) {
     ...
     */
    public void setFlightViewData(List<FlightViewData> flightViewData) {
