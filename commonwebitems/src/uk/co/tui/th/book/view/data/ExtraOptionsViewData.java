...
public class ExtraOptionsViewData {
   ...
   private boolean showNewInsurance;
     ...
     *            the insuranceContainerViewData to set
     */
     ...
     *
     * @param sessionTimePeriod
     *            the sessionTimePeriod to set
     */
     ...
     *
     * @param villaAcommodation
     *            the villaAcommodation to set
     */
    ...
    /**
     * @param extraOptionsStaticContentViewData
     *            the extraOptionsStaticContentViewData to set
     */
    ...
    /**
     * @param extraOptionsContentViewData
     *            the extraOptionsContentViewData to set
     */
 ...
 /**
    * @return the showNewInsurance
    */
   public boolean isShowNewInsurance()
   {
      return showNewInsurance;
   }

   /**
    * @param showNewInsurance the showNewInsurance to set
    */
   public void setShowNewInsurance(final boolean showNewInsurance)
   {
      this.showNewInsurance = showNewInsurance;
   }
