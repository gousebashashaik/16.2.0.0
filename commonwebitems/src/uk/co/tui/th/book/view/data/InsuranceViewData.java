...
public class InsuranceViewData {
   ...
   /**
    * @param frmSeniorPrice the frmSeniorPrice to set
    */
   ...
   /**
    * @param frmSuperSeniorPrice the frmSuperSeniorPrice to set
    */
    ...
    */
   public void setCurrencyAppendedInsWithExcessWaiver(
      final String currencyAppendedInsWithExcessWaiver)
   {
    ...
    */
   public void setRoundedFrmPrice(final String roundedFrmPrice)
   {
    ...
    */
   public void setRoundedTotalPrice(final String roundedTotalPrice)
   {
    ...
    */
   public void setRoundedPrice(final String roundedPrice)
   {
