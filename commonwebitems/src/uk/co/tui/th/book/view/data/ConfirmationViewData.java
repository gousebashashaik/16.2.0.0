...
/**
 * This class holds all the data required for the population of the view data in
...
public class ConfirmationViewData {
     ...
     */
    public void setPackageViewData(PackageViewData packageViewData) {
     ...
     */
    public void setSummaryViewData(SummaryPanelViewData summaryViewData) {
     ...
     *            the bookingDetailsViewData to set
     */
    public void setBookingDetailsViewData(
            BookingDetailsViewData bookingDetailsViewData) {
    ...
    public void setConfirmationStaticContentViewData(
            ConfirmationStaticContentViewData confirmationStaticContentViewData) {
    ...
    public void setConfirmationContentViewData(
            ConfirmationContentViewData confirmationContentViewData) {
    ...
    /**
     * @param mixedThirdPartyFlight
     *            the mixedThirdPartyFlight to set
     */
    public void setMixedThirdPartyFlight(boolean mixedThirdPartyFlight) {
