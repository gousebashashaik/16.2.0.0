...
import uk.co.tui.th.book.view.data.PaxCompositionViewData;
 ...
 * @author samantha.gd
 */
public class PaxCompositionViewDataPopulator implements Populator<BasePackage, PackageViewData>
{
    ...
    @Resource(name = "thExtraFacilityViewDataPopulator")
     ...
     *           the target
     */
    private void populatePaxCompositionViewData(final BasePackage source, final PackageViewData target)
    {
        final PaxCompositionViewData paxData = new PaxCompositionViewData();
        paxData.setNoOfAdults(getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.ADULT));
        paxData.setNoOfSeniors(getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.SENIOR)
                + getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.SUPERSENIOR));
        paxData.setNoOfChildren(getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.CHILD));
        paxData.setNoOfInfants(getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.INFANT));
        ...
        for (final PassengerViewData passenger : target.getPassenger())
        {
            ...
            {
                passenger.setPassengerCount(passenger.getIdentifier() - paxData.getNoOfAdults() - paxData.getNoOfSeniors());
            }
     ...
     * @param passenger
     */
    private void setAdultPassengerCount(final PaxCompositionViewData paxData, final PassengerViewData passenger)
    {
        ...
        {
            passenger.setPassengerCount(passenger.getIdentifier() - paxData.getNoOfAdults());
        }
    }
    ...
    private void appendChildren(final StringBuilder paxComposition, final PaxCompositionViewData paxData)
    {
        final String comma = ", ";
        final int noOfChildren = paxData.getNoOfChildren() + paxData.getNoOfInfants();
     ...
     *           the pax data
     */
    private void appendSeniors(final StringBuilder paxComposition, final PaxCompositionViewData paxData)
    {
        final String comma = ", ";
        final int noOfSenior = paxData.getNoOfSeniors();
        final int noOfChildren = paxData.getNoOfChildren() + paxData.getNoOfInfants();
     ...
     *           the pax data
     */
    private void appendAdults(final StringBuilder paxComposition, final PaxCompositionViewData paxData)
    {
        final String comma = ", ";
        final int noOfAdult = paxData.getNoOfAdults();
        final int noOfSenior = paxData.getNoOfSeniors();
     ...
     */
    @SuppressWarnings("boxing")
    private List<PassengerViewData> populatePassengerViewData(final BasePackage source)
    {
        ...
        for (final Passenger passenger : source.getPassengers())
        {
            ...
            paxData.setIdentifier(passenger.getId().intValue());
            String type;
            ...
            {
                paxData.setAge(passenger.getAge().intValue());
            }
     ...
     * @param paxData
     */
    private void populateBaggageAndMealExtraFacilitiesForEachPax(final Passenger passenger, final PassengerViewData paxData)
    {
     ...
     * @param paxData
     */
    private void populateExFacilityForEachPax(final Passenger passenger, final PassengerViewData paxData)
    {
        for (final ExtraFacility extra : passenger.getExtraFacilities())
        {
            if (StringUtils.equalsIgnoreCase(extra.getExtraFacilityCategory().getCode(), "BAG"))
            {
            ...
            else if (StringUtils.equalsIgnoreCase(extra.getExtraFacilityCategory().getCode(), "MEAL"))
            {
     ...
     * @param extraViewData
     */
    private void populateSelectedMealOption(final PassengerViewData paxData, final ExtraFacilityViewData extraViewData)
    {
        ...
        else
        {
            paxData.getSelectedMealOption().setAdultPrice(
                    paxData.getSelectedMealOption().getAdultPrice().add(extraViewData.getAdultPrice()));
            paxData.getSelectedMealOption().setChildPrice(
                    paxData.getSelectedMealOption().getChildPrice().add(extraViewData.getChildPrice()));
        }
    }
     ...
     * @param bagViewData
     */
    private void populateSelectedBaggageOption(final PassengerViewData paxData, final BaggageExtraFacilityViewData bagViewData)
    {
        ...
        {
            paxData.getSelectedBaggageOption().setPrice(paxData.getSelectedBaggageOption().getPrice().add(bagViewData.getPrice()));
        }
    }
    ...
    /**
     * This method calculates the type of passengers and create the labels accordingly.
     *
     * @param passenger
     * @param paxViewData
     *
    ...
    private void createPassengerLabel(final Passenger passenger, final PassengerViewData paxViewData)
    {
        ...
        else if (PersonType.CHILD.toString().equals(passenger.getType().toString()))
        {

            paxViewData.setPassengerLabel("Child" + " " + (++childCount));

        }
        else if (PersonType.INFANT.toString().equals(passenger.getType().toString()))
        {
    ...
    {
        return (ADULT).equals(passenger.getType().toString()) || (SENIOR).equals(passenger.getType().toString())
