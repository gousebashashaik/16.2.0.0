 ...
 *
 */
public class DataProtectionViewDataPopulator
        implements
            Populator<Object, DataProtectionViewData> {
    ...
    public void populate(final Object source,
            final DataProtectionViewData target) throws ConversionException {
        ...
        final List<DynamicContentConfigModel> dynamicContents = genericContentService
                .getDynamicContentConfig(dataProtectionCode1,
                        dataProtectionCode2, StringUtils.EMPTY);
        for (final DynamicContentConfigModel dynamicContent : dynamicContents) {
            final Map<Object, Object> dynamicContentMap = genericContentService
                    .getGenericDynamicContentValue(dynamicContent);
            for (final Entry<Object, Object> content : dynamicContentMap
                    .entrySet()) {
