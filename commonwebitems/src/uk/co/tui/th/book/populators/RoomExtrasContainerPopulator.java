   ...
   Populator<List<ExtraFacility>, ExtraFacilityViewDataContainer>
{
      ...
      final ExtraFacilityViewDataContainer target)
   {
      ...
      extraViewData
         .setCurrencyAppendedPerPersonPrice(getCurrencyAppendedPrice(unitPrice, currency));
      ...
      extraViewData.setCurrencyAppendedPrice(getCurrencyAppendedPrice(totalPrice, currency));
