 ...
 *
 */
package uk.co.tui.fo.exception;
...
public class TUIBusinessException extends Exception {
    ...
    /**
     * This constructor is used to set the TUI business related exception with
     * error code and throwable cause
     *
     * @param errorCode
     *            the error code
     ...
     *            the cause
     */
    public TUIBusinessException(final String errorCode,
            final String errorDescription, final Throwable cause) {
        super(cause);
