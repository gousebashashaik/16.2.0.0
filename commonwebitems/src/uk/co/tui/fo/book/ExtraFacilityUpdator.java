...
import uk.co.tui.fo.book.populators.ExtraFacilityViewDataPopulator;
import uk.co.tui.fo.book.populators.InsuranceViewDataPopulator;
...
import uk.co.tui.fo.book.view.data.ExtrasToPassengerRelationViewData;
...
import uk.co.tui.fo.book.view.data.PassengerViewData;
import uk.co.tui.fo.book.view.data.PaxCompositionViewData;
...
public class ExtraFacilityUpdator
{
   ...
   @Resource(name = "foExtraFacilityViewDataPopulator")
   private ExtraFacilityViewDataPopulator extraFacilityViewDataPopulator;

   @Resource(name = "foInsuranceViewDataPopulator")
