   ...
   Populator<InsuranceExtraFacility, InsuranceViewData>
{
   ...
   private void updateCutryAppendedByProfile(final InsuranceViewData insuranceViewData,
      final Price price, final String defaultCurrencyCode)
   {
      ...
      else if (price.getPriceProfile().getPersonType() == PersonType.TEEN)
      {
         insuranceViewData.setFrmAdtPrice(CurrencyUtils.getCurrencySymbol(defaultCurrencyCode)
            + price.getRate().getAmount().toString());
      }
      ...
      final InsuranceViewData insuranceViewData, final ExcessWaiverViewData excessWaiverViewData)
   {
      ...
      if (extraFacility.getInsuranceExcessWaiver().getPrice() != null)
      {
         ...
         else if (isExcessWaiverOpted(extraFacility).booleanValue())
         {
            excessWaiverViewData.setPrice(extraFacility.getInsuranceExcessWaiver().getPrice()
         ...
         excessWaiverViewData
            .setCurrencyAppendedPrice(CurrencyUtils
               .getCurrencyAppendedPriceWithDecimalPart(new BigDecimal(excessWaiverViewData
                  .getPrice())));
      }
   }
   ...
   {
      return Boolean.valueOf(extraFacility.getInsuranceExcessWaiver().isSelected());
   }
   ...
   {
      return isExcessWaiverOpted(extraFacility).booleanValue() && !isFamilyPresent(extraFacility)
