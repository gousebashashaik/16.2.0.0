...
public class PaxCompositionViewDataPopulator implements Populator<BasePackage, PackageViewData>
{
      ...
      final PackageViewData target)
   {
      ...
      paxData.setNoOfAdults(getPersonTypeCountFromPassengers(source.getPassengers(),
         PersonType.ADULT)
         + getPersonTypeCountFromPassengers(source.getPassengers(), PersonType.TEEN));
      ...
      for (final PassengerViewData passenger : target.getPassenger())
      {
         ...
         if (StringUtil.equalsIgnoreCase(passenger.getType(), CHILD))
         {
            passenger.setPassengerCount(passenger.getIdentifier() - paxData.getNoOfAdults()
               - paxData.getNoOfSeniors());
         }
         if (StringUtil.equalsIgnoreCase(passenger.getType(), INFANT))
         {
            passenger.setPassengerCount(passenger.getIdentifier() - paxData.getNoOfAdults()
               - paxData.getNoOfSeniors() - paxData.getNoOfChildren());
         }
      }
   }
    ...
    * @param paxData
    */
   private void populateBaggageAndMealExtraFacilitiesForEachPax(final Passenger passenger,
      ...
      final BaggageExtraFacilityViewData bagViewData)
   {
      ...
      else
      {
         paxData.getSelectedBaggageOption().setPrice(
            paxData.getSelectedBaggageOption().getPrice().add(bagViewData.getPrice()));
      }
   }
   ...
   private boolean isAdultType(final Passenger passenger)
   {
      return (ADULT).equals(passenger.getType().toString())
         || (TEEN).equals(passenger.getType().toString())
