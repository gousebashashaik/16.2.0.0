...
import uk.co.tui.fo.book.view.data.SummaryPanelComponentViewData;
import uk.co.tui.fo.book.view.data.SummaryPanelUrlsViewData;
...
public class SummaryPanelUrlPopulator implements Populator<String, SummaryPanelViewData>
{
    ...
    *
    * @param source - currentPage
    * @param target - SummaryPanelViewData object
      ...
      throws ConversionException
   {
      ...
      List<String> pageNames =
         getPageNamesFromConfig(StringUtil.append(packageCartService.getBasePackage()
            .getPackageType().toString(), ".summary.componentOrder"));
      ...
      for (final String page : pageNames)
      {
         ...
         urlMap.put(bookFlowUrls.getValue(brand + "." + page + NAME),
            populateSearchResultsURL(httpBaseURL, page, brand, target));
      }
    ...
    * @return
    */
   private String populateSearchResultsURL(final String httpBaseURL, final String page,
      final String brand, final SummaryPanelViewData target)
   {
      final String url =
         StringUtil.append(httpBaseURL, bookFlowUrls.getValue(brand + "." + page + ".url"));
      final String homePageURL =
         Config.getString(StringUtil.append(brand, ".S2.home.page.url"),
            "http://flights.thomson.co.uk");
      target.setHomePageURL(homePageURL);
      if ("SR".equals(page))
      {
         return StringUtil.append(url,
    ...
    */
   private List<SummaryPanelComponentViewData> getSummaryPanelIndicators(final String pageLabel,
      final Map<String, String> urlMap)
   {
      final List<SummaryPanelComponentViewData> summaryPanelComponentList =
         new ArrayList<SummaryPanelComponentViewData>();
      ...
      for (final String page : pageNames)
      {
         if (StringUtils.equalsIgnoreCase(bookFlowUrls.getValue(brand + "." + page + ".id"),
            pageLabel))
         {
            final int index =
               summaryPanelComponentList.indexOf(new SummaryPanelComponentViewData(null,
                  bookFlowUrls.getValue(brand + "." + page + NAME), null));
      ...
      {
         final int index =
            summaryPanelComponentList.indexOf(new SummaryPanelComponentViewData(null, bookFlowUrls
               .getValue(brand + ".BO.name"), null));
    ...
    *
    * @param summaryPanelComponentList the summary panel component list
    * @param indexValue the index
    */
   private void populateExpandAttribute(
      final List<SummaryPanelComponentViewData> summaryPanelComponentList, final int indexValue)
   {
      ...
      final List<String> pgNames, final String brand)
   {
      ...
      {
         final SummaryPanelComponentViewData summaryComponent =
            new SummaryPanelComponentViewData(null, bookFlowUrls.getValue(StringUtil.append(brand,
               ".", pageName, NAME)), null);
