...
/**
 * The Class AlertPassengerViewDataPopulator.
 *
 * @author sujithks
 */
public class AlertPassengerViewDataPopulator implements Populator<Feedback, AlertViewData>
{
     ...
     *
     */
    public void populate(final Feedback source, final AlertViewData target) throws ConversionException
    {
        target.setMessageText(messagePropertyReader.substitute("Infant_Notyet_Born_Text", null));
