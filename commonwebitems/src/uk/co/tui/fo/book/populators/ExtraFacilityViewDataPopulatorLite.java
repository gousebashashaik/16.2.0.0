 ...
 *
 */
public class ExtraFacilityViewDataPopulatorLite implements
   Populator<ExtraFacility, ExtraFacilityViewData>
{
      ...
      final ExtraFacilityViewData target)
   {
      ...
      bagViewData.setCurrencyAppendedPrice(CurrencyUtils.getCurrencyAppendedPrice(bagModel
         .getPrice().getRate().getAmount()));
   ...
   private void populatePrice(final ExtraFacilityViewData target, final ExtraFacility source)
   {
      ...
      for (final Price price : source.getPrices())
      {
         ...
         {
            totalPrice = totalPrice.add(moneyModel.getAmount());
         }
      }
    ...
    * @return boolean
    */
   private boolean isExtraIncluded(final ExtraFacility extraFacility)
   {
      return extraFacility.getSelection().equals(FacilitySelectionType.INCLUDED);
   }
    ...
    * @return boolean
    */
   private boolean isExtraFree(final ExtraFacility extraFacility)
   {
      return extraFacility.getSelection().equals(FacilitySelectionType.FREE);
   }
   ...
   private String getTransferDescription(final ExtraFacility source)
   {
      ...
      if (source.getSelection().equals(FacilitySelectionType.FREE)
         || source.getSelection().equals(FacilitySelectionType.INCLUDED))
      {
         return getDescription(source.getExtraFacilityCode());
      }
      else
