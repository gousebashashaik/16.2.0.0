...
public class CarHireUpgradeExtraFacilityStore
{
     ...
     *
     * @param carHireSearchResponse
     *           the carHireSearchResponse to set
     */
    public void setCarHireSearchResponse(final Map<String, CarHireSearchResponse> carHireSearchResponse)
    {
    ...
    {
        final List<ExtraFacilityCategory> categoryList = Collections.emptyList();
        if (getCarHireSearchResponse().get(packageCode) != null)
        {
            return getCarHireSearchResponse().get(packageCode).getExtraFacilityCategoryList();
        }
        return categoryList;
    }
     ...
     *           the car hire search response
     */
    public void add(final CarHireSearchResponse carHireSearchResponse)
    {
