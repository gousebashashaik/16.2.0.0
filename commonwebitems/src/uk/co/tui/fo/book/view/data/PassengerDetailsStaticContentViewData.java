...
public class PassengerDetailsStaticContentViewData
{
    ...
    /**
     * @param passengerContentMap
     *           the passengerContentMap to set
     */
     ...
     */
    public void setGenericContentViewData(final GenericStaticContentViewData genericContentViewData)
    {
     ...
     */
    public void setSummaryContentViewData(final SummaryPanelStaticContentViewData summaryContentViewData)
    {
