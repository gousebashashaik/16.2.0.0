...
/**
 * This class holds the datas related to fill the firstname,surname and date of birth
 *
 * @author sreevidhya.r
 *
 */
public class InfantNotYetBornViewData
{
    ...
    /**
     * @param alertInfantNotYetBorn
     *           the alertInfantNotYetBorn to set
     */
    public void setAlertInfantNotYetBorn(final String alertInfantNotYetBorn)
    {
