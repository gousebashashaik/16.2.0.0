...
public class ExtraOptionsStaticContentViewData {
    ...
    /**
     * @param navigationStaticContentViewData the navigationStaticContentViewData to set
     */
    public void setNavigationStaticContentViewData(
            NavigationStaticContentViewData navigationStaticContentViewData) {
    ...
    /**
     * @param extraContentMap the extraContentMap to set
     */
    ...
    /**
     * @param insuranceStaticContentViewData the insuranceStaticContentViewData to set
     */
