...
import uk.co.tui.fo.book.facade.BookFacade;
import uk.co.tui.fo.book.populators.AlertPassengerViewDataPopulator;
import uk.co.tui.fo.book.populators.AlertPopulator;
import uk.co.tui.fo.book.populators.BookingDetailsViewDataPopulator;
import uk.co.tui.fo.book.populators.HolidayInclusivePackagePopulator;
import uk.co.tui.fo.book.store.CarHireUpgradeExtraFacilityStore;
...
public class BookFacadeImpl implements BookFacade
{
   ...
   @Resource(name = "foHolidayInclusivePackagePopulator")
   ...
   @Resource(name = "foAlertPassengerViewDataPopulator")
    ...
    */
   @Override
   public List<AlertViewData> checkPriceAndAvailability() throws TUIBusinessException,
   ...
   public BookingDetailsViewData confirmBooking()
   {
      ...
      catch (final BookServiceException e)
      {
         ...
         LOGGER.error("Caught BookServiceExcepion " + e.getMessage(), e);
      }
      ...
      final String contextPath) throws FlightSoldOutException, TUIBusinessException
   {
      ...
      paymentRequest.setClientURL(StringUtil.append(Config.getParameter(brandType
         + ".S2.home.page.url")));
      ...
      try
      {
         final List<AlertViewData> alertViewDataList = checkPriceAndAvailability();
         populateAlertViewData(paymentRequest, alertViewDataList);
      }
