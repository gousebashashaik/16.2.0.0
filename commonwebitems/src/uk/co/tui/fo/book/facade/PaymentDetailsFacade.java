...
public interface PaymentDetailsFacade
{
     ...
     */
    BasePackage populatePackageData(PassengerDetailsFormBean formBean, BasePackage packageModel);
     ...
     *           the is lapland day trip
     * @return Map<String, String>
     */
    Map<String, String> populateBreadcrumbUrls(SummaryPanelViewData viewData, String hostPrefix, boolean isLaplandDayTrip);
