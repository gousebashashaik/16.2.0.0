 ...
 *
 */
package uk.co.tui.fj.book.impex.util;
...
public class TracsPriceCodesImportContext {
    ...
    /** The log. */
    private static final Logger LOGGER= Logger.getLogger(TracsPriceCodesImportContext.class);
    ...
    public void prepareTracsPriceCodes(final Map<Integer, String> line) {
        ...
        Map<String, String> duplicateFinder = new HashMap<String, String>();
