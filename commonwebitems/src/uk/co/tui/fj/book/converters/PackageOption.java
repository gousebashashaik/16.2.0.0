package uk.co.tui.fj.book.converters;
...
public class PackageOption
{
    ...
    private static List<PackageOption> internalValues = Arrays.asList(FLIGHT, PRICE_BREAKDOWN, ACCOMMODATION, PAX_COMPOSITION,
