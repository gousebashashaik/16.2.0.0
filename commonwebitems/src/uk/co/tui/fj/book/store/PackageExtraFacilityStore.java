...
public class PackageExtraFacilityStore
{
    ...
    private Map<String, PackageExtraFacilityResponse> packageExtraFacilityResponse = new HashMap<String, PackageExtraFacilityResponse>();
     ...
     *
     * @param packageExtraFacilityResponse
     *            the package extra facility response
     */
    public void add(final PackageExtraFacilityResponse packageExtraFacilityResponse)
    {
        this.getPackageExtraFacilityResponse().put(packageExtraFacilityResponse.getPackageId(), packageExtraFacilityResponse);
    }


    /**
     * Gets the extra facility category list for the supplied package code from
     * the store.
     *
     * @param packageCode
     *            the package code
    ...
    public List<ExtraFacilityCategory> getExtraFacilityLite(final String packageCode)
    {
        ...
        {
            return this.getPackageExtraFacilityResponse().get(packageCode).getExtraFacilityCategoryList();
        }
