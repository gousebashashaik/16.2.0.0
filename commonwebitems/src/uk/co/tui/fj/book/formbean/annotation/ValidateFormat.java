...
import uk.co.tui.fj.book.formbean.annotationimp.FormatValidator;
...
public @interface ValidateFormat {
   ...
   int MAX = BookFlowConstants.SIXTY;
     ...
     */
    String message() default "{uk.co.tui.fj.book.formbean.customvalidators.ValidateFormat.message}";
