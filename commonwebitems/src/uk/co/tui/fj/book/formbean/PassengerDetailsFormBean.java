 ...
 *
 */
package uk.co.tui.fj.book.formbean;
...
import uk.co.tui.fj.book.formbean.annotation.CompareEmail;
import uk.co.tui.fj.book.formbean.annotation.ValidateFormat;
...
public final class PassengerDetailsFormBean
{
   ...
   // @ValidateFormat(regEx = "[a-zA-Z\\'\\., \\-\\s*]+", max = TOWN_MAX, emptyCheck = true, message
   // = PassengerDetailConstants.TOWN_MESS)
   private String town;

   /** Customer's county. */
   // @ValidateFormat(regEx = "[a-zA-Z0-9\\'\\., \\-\\s*]+", max = COUNTY_MAX, emptyCheck = true,
   // message = PassengerDetailConstants.COUNTY_MESS)
