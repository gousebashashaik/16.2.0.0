...
import uk.co.tui.fj.book.view.data.DepositData;
...
public class BookingDetailsViewDataPopulator
{
      ...
      final BookingDetailsViewData bookingDetailsViewData)
   {
      ...
      populateAPIandAccountURL(bookingDetailsViewData);
      bookingDetailsViewData.setPaymentOptionsUrl(Config.getParameter("FJ_PAYMENT_OPTIONS_URL"));
   ...
   private void populateAPIandAccountURL(final BookingDetailsViewData bookingDetailsViewData)
   {
