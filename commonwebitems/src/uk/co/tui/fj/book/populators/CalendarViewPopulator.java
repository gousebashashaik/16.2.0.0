...
import uk.co.tui.fj.book.view.data.AirportListViewData;
import uk.co.tui.fj.book.view.data.CalendarViewData;
import uk.co.tui.fj.book.view.data.DepartureDateAvailabilityViewData;
import uk.co.tui.fj.book.view.data.DurationListViewData;
import uk.co.tui.fj.book.view.data.FlightOptionsFilterViewData;
import uk.co.tui.fj.book.view.data.FlightViewData;
import uk.co.tui.fj.book.view.data.Leg;
...
public class CalendarViewPopulator
{
   ...
   private static final TUILogUtils LOGGER = new TUILogUtils("CalendarViewPopulator");
