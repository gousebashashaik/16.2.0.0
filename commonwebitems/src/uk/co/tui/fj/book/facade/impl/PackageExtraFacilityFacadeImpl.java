...
import static uk.co.tui.fj.book.constants.BookFlowConstants.EMPTY;
import static uk.co.tui.fj.book.constants.BookFlowConstants.EXTRAOPTIONS;
import static uk.co.tui.fj.book.constants.BookFlowConstants.ROOMOPTIONS;
...
import uk.co.tui.fj.book.facade.PackageExtraFacilityFacade;
import uk.co.tui.fj.book.facade.PackageSwapFacade;
import uk.co.tui.fj.book.populators.AlertPopulator;
import uk.co.tui.fj.book.populators.CarHireUpgradeViewDataPopulatorLite;
import uk.co.tui.fj.book.populators.ExtraFacilityViewDataPopulatorLite;
import uk.co.tui.fj.book.populators.PackageExtrasContainerPopulator;
import uk.co.tui.fj.book.populators.PackageViewDataPopulator;
import uk.co.tui.fj.book.populators.PassengerViewDataPopulator;
import uk.co.tui.fj.book.populators.RoomExtrasContainerPopulator;
import uk.co.tui.fj.book.populators.SelectedCarHireViewDataPopulator;
...
import uk.co.tui.fj.book.view.data.ExtraOptionsContentViewData;
import uk.co.tui.fj.book.view.data.ExtraOptionsStaticContentViewData;
...
public class PackageExtraFacilityFacadeImpl implements PackageExtraFacilityFacade
{
   ...
   @Resource(name = "fjPackageExtrasContainerPopulator")
   ...
   @Resource(name = "fjExtraStaticContentViewDataPopulator")
   ...
   @Resource(name = "fjExtraOptionsContentViewDataPopulator")
   private Populator<Object, ContentViewData> extraOptionsContentViewDataPopulator;
   
   @Resource(name = "fjCarHireUpgradeViewDataPopulatorLite")
   ...
   @Resource
   private PackageViewDataPopulator fjPackageViewDataPopulator;
   
   @Resource(name = "fjSelectedCarHireViewDataPopulator")
   ...
   {
      updatePackageIntoCart();
      fjPackageViewDataPopulator.populate(packageModel, extraOptionsViewData.getPackageViewData());
      ...
      for (final ExtraFacility extraModel : modelExtras)
      {
         ...
         extra.setCurrencyAppendedPrice(getCurrencyAppendedPrice(
            extraModel.getPrices()
               .get(extraFacilityUpdator.getPriceIndexBasedOnExFacilityType(extraModel)).getRate()
