...
import uk.co.tui.fj.book.populators.CalendarViewPopulator;
import uk.co.tui.fj.book.populators.FlightExtrasContainerPopulator;
...
import uk.co.tui.fj.book.store.FlightExtraFacilityStore;
import uk.co.tui.fj.book.view.data.CalendarViewData;
import uk.co.tui.fj.book.view.data.ContentViewData;
import uk.co.tui.fj.book.view.data.FlightOptionsContentViewData;
import uk.co.tui.fj.book.view.data.FlightOptionsStaticContentViewData;
...
public class FlightOptionsPageFacadeImpl implements FlightOptionsPageFacade
{
    ...
    */
   @Override
   public void renderFlightOptions(final FlightOptionsViewData viewData)
      ...
      final int payablePax)
   {
      ...
      if (durationTeaserPackage != null)
      {
         ...
         durationTeaserViewData.setDiffTotalPrice(CurrencyUtil.getCurrencyAppendedPrice(
            diffTotalPrice, currencyResolver.getSiteCurrency()));
      ...
      final int payablePax)
   {
      ...
      if (dateAndTimeTeaserPackage != null)
      {
         ...
         departureDateTeaserViewData.setDiffTotalPrice(CurrencyUtil.getCurrencyAppendedPrice(
            diffTotalPrice, currencyResolver.getSiteCurrency()));
      ...
      final int payablePax)
   {
      ...
      if (airportTeaserPackage != null)
      {
         ...
         airportTeaserViewData.setDiffTotalPrice(CurrencyUtil.getCurrencyAppendedPrice(
            diffTotalPrice, currencyResolver.getSiteCurrency()));
   ...
   public FlightOptionsViewData renderAvailabilityCalendar(final FlightFilterCriteria filterCriteria)
   {
      ...
      final BasePackage selectedPackage = getBasePackageFromCart();
   ...
   private void populateContainerView(final FlightOptionsViewData viewData, final String packageCode)
   {
      ...
      extraFacilityUpdator.sortSeatsByCode(viewData.getExtraFacilityViewDataContainer()
         .getSeatOptions());
