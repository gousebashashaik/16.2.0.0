...
import uk.co.tui.fj.book.facade.PassengerDetailsPageFacade;
import uk.co.tui.fj.book.populators.AlertViewDataPopulator;
...
import uk.co.tui.fj.book.view.data.PassengerData;
...
import uk.co.tui.fj.book.view.data.PromotionalCodeViewData;
...
public class PassengerDetailsPageFacadeImpl implements PassengerDetailsPageFacade
{
	...
	@Resource(name = "fjDataProtectionViewDataPopulator")
