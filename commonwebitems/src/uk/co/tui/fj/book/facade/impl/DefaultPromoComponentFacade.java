...
import uk.co.tui.fj.book.facade.PromoComponentFacade;
...
public class DefaultPromoComponentFacade implements PromoComponentFacade
{
    ...
    @Resource
    private Populator<Object, PassengerDetailsStaticContentViewData> fjPassengerStaticContentViewDataPopulator;
    ...
    private void populatePassengerStaticContentViewData(final PassengerDetailsViewData viewData)
    {
        ...
        fjPassengerStaticContentViewDataPopulator.populate(new Object(), passengerDetailsStaticContentViewData);
    ...
    public PassengerDetailsViewData removeExistingPromoCode()
    {
        ...
        fjPackageViewDataPopulator.populate(packageModel, passengerDetailsViewData.getPackageViewData());
