 ...
 *
 */
package uk.co.tui.web.common.jalo;
...
/**
 * This is the extension manager of the Commonwebitems extension.
 */
public class CommonwebitemsManager extends GeneratedCommonwebitemsManager
{
    /** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
    private static final Logger LOG = Logger.getLogger(CommonwebitemsManager.class.getName());
     ...
     */
    public static CommonwebitemsManager getInstance()
    {
        return (CommonwebitemsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
                CommonwebitemsConstants.EXTENSIONNAME);
    }
     ...
     */
    public CommonwebitemsManager() // NOPMD
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("constructor of CommonwebitemsManager called.");
        }
    }
    ...
    public void init()
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("init() of CommonwebitemsManager called. " + getTenant().getTenantID());
        }
    }
    ...
    public void destroy()
    {
        if (LOG.isDebugEnabled())
        {
            LOG.debug("destroy() of CommonwebitemsManager called, current tenant: " + getTenant().getTenantID());
        }
    }
