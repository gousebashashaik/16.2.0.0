...
import uk.co.tui.book.view.data.AirportListViewData;
import uk.co.tui.book.view.data.CalendarViewData;
import uk.co.tui.book.view.data.DepartureDateAvailabilityViewData;
import uk.co.tui.book.view.data.DurationListViewData;
import uk.co.tui.book.view.data.FlightOptionsFilterViewData;
import uk.co.tui.book.view.data.FlightViewData;
import uk.co.tui.book.view.data.Leg;
import uk.co.tui.book.view.data.PackageViewData;
import uk.co.tui.book.view.data.Schedule;
