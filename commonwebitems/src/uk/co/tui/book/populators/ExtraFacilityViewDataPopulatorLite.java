   ...
   Populator<ExtraFacility, ExtraFacilityViewData>
{
    ...
    */
   private void populatePrice(final Price price, final ExtraFacilityViewData target)
   {
   ...
   {
      return extraFacilityModel.getSelection().equals(FacilitySelectionType.INCLUDED);
   }
   ...
   {
      return extraFacilityModel.getSelection().equals(FacilitySelectionType.FREE);
   }
