...
import uk.co.tui.book.view.data.Airport;
...
public class FlightViewDataPopulator
    ...
    private void populateLegs(final List<Leg> legs,
            final List<uk.co.tui.book.view.data.Leg> legsViewData) {

        legsViewData.clear();
        for (final Leg eachLeg : legs) {
            final uk.co.tui.book.view.data.Leg eachLegViewData = new uk.co.tui.book.view.data.Leg();
