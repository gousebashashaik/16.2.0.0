...
import uk.co.tui.book.view.data.DepositData;
...
public class BookingDetailsViewDataPopulator
{
      ...
      final BookingDetailsViewData bookingDetailsViewData)
   {
      ...
      bookingDetailsViewData.setPaymentOptionsUrl(Config.getParameter("FC_PAYMENT_OPTIONS_URL"));
      ...
      final BookingDetailsViewData bookingDetailsViewData)
   {
      ...
      if (StringUtils.isNotEmpty(switchOffStartDate) && StringUtils.isNotEmpty(switchOffEndDate))
      {
         ...
         alterDepartureDate(bookingDetailsViewData, seasonStartSwitchDate, seasonEndSwitchDate,
            departureDate);
      ...
      else
      {
         ...
         bookingDetailsViewData.setMyAccountUrl(Config.getParameter("MY_FIRSTCHOICE_ACCOUNT_URL"));
      }
   }
    ...
    * @param departureDate
    */
   private void alterDepartureDate(final BookingDetailsViewData bookingDetailsViewData,
      final Date seasonStartSwitchDate, final Date seasonEndSwitchDate, final Date departureDate)
   {
      if (departureDateBtSwitchOffRange(seasonStartSwitchDate, seasonEndSwitchDate, departureDate))
      {
