...
import uk.co.portaltech.travel.enums.InsuranceType;
...
import uk.co.tui.domain.model.InsuranceExtraFacilityModel;
import uk.co.tui.domain.model.PassengerModel;
import uk.co.tui.domain.model.PriceModel;

/**
 * @author akshay.an
 *
 */
public class InsuranceViewDataPopulator implements
   Populator<InsuranceExtraFacilityModel, InsuranceViewData>
{
   ...
   @Override
   public void populate(final InsuranceExtraFacilityModel extraFacility,
      final InsuranceViewData insuranceViewData) throws ConversionException
   {
      ...
      insuranceViewData.setSelected(extraFacility.getSelected().booleanValue());
      ...
      for (final PriceModel price : extraFacility.getPrices())
      {
   ...
   private boolean isFamilyPresent(final InsuranceExtraFacilityModel extraFacility)
   {
      ...
      final PriceModel price)
   {
      ...
      if (price.getPriceProfile() != null)
      {
         ...
         else if (price.getPriceProfile().getPersonType() == PersonType.CHILD)
         {
    ...
    * @return boolean
    */
   private boolean isAdultPriceUpdate(final InsuranceViewData insuranceViewData,
      final PriceModel price)
   {
      return price.getPriceProfile().getPersonType() == PersonType.ADULT
    ...
    * @param insuranceViewData
    */
   private void updateQuantity(final InsuranceExtraFacilityModel extraFacility,
    ...
    */
   @SuppressWarnings(BookFlowConstants.BOXING)
   private void populateExWaiverViewData(final InsuranceExtraFacilityModel extraFacility,
      final InsuranceViewData insuranceViewData)
   {
      if (extraFacility.getInsuranceExcessWaiver() != null)
      {
         final ExcessWaiverViewData excessWaiverViewData = new ExcessWaiverViewData();
         excessWaiverViewData.setCode(extraFacility.getInsuranceExcessWaiver().getCode());
    ...
    */
   @SuppressWarnings(BookFlowConstants.BOXING)
   private void updateInsurancePrice(final InsuranceExtraFacilityModel extraFacility,
    ...
    */
   @SuppressWarnings(BookFlowConstants.BOXING)
   private boolean isNonFamilyExcessWaiverOpted(final InsuranceExtraFacilityModel extraFacility)
   {
    ...
    * @return boolean
    */
   private Boolean isExcessWaiverOpted(final InsuranceExtraFacilityModel extraFacility)
   {
      return extraFacility.getInsuranceExcessWaiver().getSelected();
   }
    ...
    * @return the string
    */
   private BigDecimal calculateTotalPrice(final InsuranceExtraFacilityModel extraFacility)
   {
      final List<PriceModel> extraPrices = extraFacility.getPrices();
      BigDecimal total = BigDecimal.ZERO;
      for (final PriceModel eachPriceModel : extraPrices)
      {
    ...
    * @return types
    */
   private Collection<String> getTypes(final Collection<PassengerModel> passengers)
   {
      final List<String> types = new ArrayList<String>();
      for (final PassengerModel passenger : passengers)
      {
         types.add(passenger.getType().getCode());
      }
      return types;
   }
}
