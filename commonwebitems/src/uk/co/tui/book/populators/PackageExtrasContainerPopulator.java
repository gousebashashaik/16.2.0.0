...
import uk.co.tui.book.content.populators.ExcursionContentViewDataPopulatorLite;
   ...
   Populator<List<ExtraFacility>, ExtraFacilityViewDataContainer>
{
      ...
      final ExtraFacilityViewDataContainer extraFacilityViewDataContainer)
   {
      ...
      {
         extraViewData.setCurrencyAppendedPerTaxiPrice(getCurrencyAppendedPrice(
      ...
      final int selectedQuantity, final int noOfInfants)
   {
      if (noOfInfants >= 1)
      {
         ...
         final BigDecimal pricePerNight =
            unitPrice.divide(noOfNightsInBigDecimal, TWO, RoundingMode.HALF_UP);
         ...
         extraFacilityViewData.setCurrencyAppendedPricePerNight(getCurrencyAppendedPricePerNight(
            pricePerNight.setScale(TWO, RoundingMode.HALF_UP), currency));
      ...
      final List<ExtraFacilityCategoryViewData> ancillaryCategoryViewData)
   {
      ...
      extraFacilityViewData.setCurrencyAppendedAdultPrice(getCurrencyAppendedPrice(
         unitPrice.setScale(TWO, RoundingMode.HALF_UP), currency));
      extraFacilityViewData.setCurrencyAppendedChildPrice(getCurrencyAppendedChildPrice(
         unitPrice.setScale(TWO, RoundingMode.HALF_UP), currency));
