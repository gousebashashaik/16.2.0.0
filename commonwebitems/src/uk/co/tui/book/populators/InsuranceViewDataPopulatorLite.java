...
import uk.co.tui.book.view.data.ExcessWaiverViewData;
   ...
   Populator<InsuranceExtraFacility, InsuranceViewData>
{
      ...
      final Price price)
   {
      ...
      if (price.getPriceProfile() != null)
      {
         ...
         getInsurancePrice(insuranceViewData, price, defaultCurrencyCode);
      }
   }
    ...
    * @param defaultCurrencyCode
    */
   private void getInsurancePrice(final InsuranceViewData insuranceViewData, final Price price,
