...
/**
   ...
   {
      if (CollectionUtils.isEmpty(this.extraFacilityViewData))
      {
         this.extraFacilityViewData = new ArrayList<ExtraFacilityViewData>();
      }
   ...
   public void setDisableExtraFacilityOptionAvailable(boolean disableExtraFacilityOptionAvailable)
   {
    ...
    public List<ExtrasToPassengerRelationViewData> getExtrasToPassengerMapping() {
        if (CollectionUtils.isEmpty(this.extrasToPassengerMapping)) {
            this.extrasToPassengerMapping = new ArrayList<ExtrasToPassengerRelationViewData>();
        }
    ...
    public ExtraFacilityContentViewData getExtraContent() {
        ...
        {
            this.extraContent = new ExtraFacilityContentViewData();
        }
        return extraContent;
    }
