...
public class ExtraFacilityViewData
{
   ...
   {
      return this.price.setScale(ViewDataConstants.ALLOWED_DECIMAL_TWO, BigDecimal.ROUND_UP);
   }
   ...
   {
      if (this.passengerExtraFacilityMapping == null)
      {
         this.passengerExtraFacilityMapping = new PassengerExtraFacilityMapping();
      }
