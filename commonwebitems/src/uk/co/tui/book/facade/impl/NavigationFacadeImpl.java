...
import uk.co.tui.book.facade.NavigationFacade;
...
public class NavigationFacadeImpl implements NavigationFacade
{
   ...
   @Resource
   private Populator<Holiday, BasePackage> holidayInclusivePackagePopulator;
    ...
    */
   @Override
   public TraversalData buildNavigationData(final String page)
   {
