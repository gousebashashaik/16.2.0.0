...
import uk.co.tui.book.facade.AllInclusiveBoardFacade;
...
public class AllInclusiveBoardFacadeImpl implements AllInclusiveBoardFacade
{
   ...
   public BoardBasisViewData getBoardBasisViewData()
   {
      ...
      boardBasisViewData.setFeatureCodesAndValues(featureCodeAndValues);
    ...
    *
    */
   public Map<String, List<Object>> getOtherBoardBasisFacilities()
   {
      ...
      final List<String> foodAndDrinkfacilityCodes)
   {
      ...
      {
         facilitiy.put("name", Arrays.asList((Object) facilityModel.getName()));
