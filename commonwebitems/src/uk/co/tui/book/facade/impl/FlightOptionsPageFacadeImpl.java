...
import uk.co.tui.book.populators.CalendarViewPopulator;
import uk.co.tui.book.populators.FlightExtrasContainerPopulator;
...
import uk.co.tui.book.view.data.CalendarViewData;
...
import uk.co.tui.book.view.data.teasers.AirportTeaserViewData;
import uk.co.tui.book.view.data.teasers.DepartureDateTeaserViewData;
import uk.co.tui.book.view.data.teasers.DurationTeaserViewData;
...
public class FlightOptionsPageFacadeImpl implements FlightOptionsPageFacade
{
   ...
   /** The duration haul type service. */
   // @Resource
   ...
   /**
    * This method is facilitates the rendering of Alternate Flights Component in Flight options
    * page.
    *
   ...
   public FlightOptionsViewData renderFlightOptions() throws TUIBusinessException
   {
      ...
      final List<BasePackage> singleAccomResultPackages =
   ...
   public void populateAvlQuantityForStandardSeats(final BasePackage packageModel)
   {
      ...
      final List<ExtraFacility> extraFacilitiesList =
         flightExtraStore.getExtraFacilityFromAllLegsBasedOnCabCls(packageId,
            ExtraFacilityConstants.DEFAULT_SEAT, getCabinClassFromPackage());
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.tui.book.facade.FlightOptionsPageFacade#updatePackageIntoCart(uk
    * .co.tui.domain.model.BasePackage)
    */
   @Override
   ...
   public FlightOptionsViewData renderFlightOptionsForMulticomThirdPartyFlight()
   {
      ...
      final List<BasePackage> singleAccomResultPackages = getAlternateFlights(packageModel);
      packageUpdationService.updateDreamLinerInfo(singleAccomResultPackages, packageModel);
      // populate view data
    ...
    */
   private List<BasePackage> getAlternateFlights(final BasePackage packageModel)
   {
   ...
   {
      return PackageUtilityService.getCabinClass(packageCartService.getBasePackage());
   }
   ...
   public void populateThirdPartyFlightInfo(final FlightOptionsViewData viewData)
   {
      ...
      final String thirdPFCodes =
         tuiConfigService.getConfigValue("FC.thirdPartyFlight.carrierCodeList");
      ...
      final List<String> mixedLegCodes, final Set<String> carrierCodes)
   {
      ...
      populateThirdPartyCodes(mixedLegCodes, carrierCodes);
    ...
    * @param carrierCodes
    */
   private void populateThirdPartyCodes(final List<String> mixedLegCodes,
      final Set<String> carrierCodes)
   {
