...
public class FlightExtraFacilityStore
{
   ...
   /**
    * Gets the grouped extras map.
    *
    * @param combinedExtraFacilityList the combiled extra facility list
    * @return the grouped extras map
    */
      ...
      final String extraFacilityCode, final String cabClsCode)
   {
      ...
      Map<String, Map<String, List<ExtraFacility>>> flightExtrasMap = Collections.emptyMap();
      flightExtrasMap = this.getCabinWiseGroupedFlightExtrasResponse().get(packageId);
