...
public class AlternativeFlightStore {
    ...
    public BasePackage getPackageHoliday(final String packageId) {
        for (final BasePackage pkg : this.packageHolidays) {
     ...
     *            the duration
     */
    public void addDuration(final String duration) {
     ...
     *            the durations
     */
    public void addDurations(final List<String> durations) {
     ...
     */
    public boolean isDurationAvailable(final String duration) {
        for (final String dur : this.durations) {
