...
public class PackageExtraFacilityStore {
     ...
     */
    public void add(PackageExtraFacilityResponse packageExtraFacilityResponse)
    {
    ...
    public List<ExtraFacilityCategory> getExtraFacilityLite(String packageCode) {
        ...
        if (SyntacticSugar.isNotNull(this.getPackageExtraFacilityResponse()
                .get(packageCode))) {
