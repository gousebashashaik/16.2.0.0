 ...
 *
 */
package uk.co.tui.book.formbean;
...
import uk.co.tui.book.formbean.annotation.CompareEmail;
import uk.co.tui.book.formbean.annotation.ValidateFormat;
import uk.co.tui.book.formbean.annotation.constants.PassengerDetailConstants;
...
public final class PassengerDetailsFormBean
{
   ...
   private static final int POST_CODE_MAX = 8;

   private static final int TELEPHONE_NO_MAX = 20;
   ...
   /** Customer's county. */
   @ValidateFormat(regEx = "[a-zA-Z\\'\\., \\-\\s*]+", max = COUNTY_MAX, emptyCheck = true, message = PassengerDetailConstants.COUNTY_MESS)
   ...
   /** Customer's postCode. */
   @ValidateFormat(regEx = "^([A-Pa-pR-UWYZr-uwyz0-9][A-Ha-hK-Yk-y0-9][AEHMNPRTUVXYaehmnprtuvxy0-9]?[ABEHMNPRVWXYabehmnprvwxy0-9]?[ \\s]{0,1}[0-9][ABD-HJLN-UW-Zabd-hjln-uw-z]{2}|GIR 0AA)$", max = POST_CODE_MAX, emptyCheck = true, message = PassengerDetailConstants.POSTCODE_MESS)
   private String postCode;

   /** Customer's telephone number. */
   @ValidateFormat(regEx = "^(0([4]{1}[0-3,5-9]{1}[0-9]{1}[0-9]{7}|[1-3,5-9]{1}[0-9]{1}[0-9]{8})|[1-9]{1}[0-9]{9})$", emptyCheck = true, max = TELEPHONE_NO_MAX, message = PassengerDetailConstants.TELEPHONE_MESS)
