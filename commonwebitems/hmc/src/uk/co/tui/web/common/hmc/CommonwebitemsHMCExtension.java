 ...
 *  
 */
package uk.co.tui.web.common.hmc;
...
/**
 * Provides necessary meta information about the commonwebitems hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class CommonwebitemsHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CommonwebitemsHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "uk.co.tui.web.common.hmc.locales";
