...
<%@ taglib prefix="cache" uri="http://hybris.com/tld/ywebcache"%>
    ...
    <div id="wrapper">
        ...
        <div id="header">
		<cache:cache cache="fragmentCache" id="template2-header">
        ...
        <div id="content">
            <cms:slot contentSlot="${cms_standard_body}" var="comp">
                <cms:component component="${comp}" />
            </cms:slot>
		</div>
	<cache:cache cache="fragmentCache" id="template2-inner-footer">
		<div id="inner-footer">
    ...
    <footer id="footer">
	<cache:cache cache="fragmentCache" id="template2-footer">
