define("tui/inventoryGetPrice/view/InventoryGetPriceModal", [
    "dojo",
    "dojo/store/Observable",
    "tui/searchPanel/model/DestinationModel",
    "tui/searchPanel/store/DestinationMultiFieldStore",
    "tui/searchGetPrice/view/GetPriceModal"], function (dojo, Observable, DestinationModel, DestinationMultiFieldStore) {

    dojo.declare("tui.inventoryGetPrice.view.InventoryGetPriceModal", [tui.searchGetPrice.view.GetPriceModal], {
    ...
    return tui.inventoryGetPrice.view.InventoryGetPriceModal;
});