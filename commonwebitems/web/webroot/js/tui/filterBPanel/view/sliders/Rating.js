define("tui/filterBPanel/view/sliders/Rating", [
    "dojo",
    'dojo/dom-attr',
    'dojo/dom-class',
    "dojo/topic",
    "tui/filterBPanel/view/sliders/SlidingFilter"], function (dojo, domAttr, domClass, topic) {

    dojo.declare("tui.filterBPanel.view.sliders.Rating", [tui.filterBPanel.view.sliders.SlidingFilter], {

        valueTmpl: "${value}",

        visibilityKey : 'firstChoiceRatingFilter',
    ...
    return tui.filterBPanel.view.sliders.Rating;
});