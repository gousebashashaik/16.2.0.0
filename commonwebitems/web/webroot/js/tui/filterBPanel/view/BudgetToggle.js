define("tui/filterBPanel/view/BudgetToggle", [
  "dojo",
  "dojo/dom-class",
  "dojo/query",
  "dojo/_base/xhr",
  "dojo/_base/connect",
  "tui/widget/form/ToggleSwitch"], function (dojo, domClass, query, xhr, connect) {
  ...
  dojo.declare("tui.filterBPanel.view.BudgetToggle", [tui.widget.form.ToggleSwitch], {
    ...
    disableSliders: function() {
      ...
      dojo.addClass(query("#price-filter")[0],"disabled");
    ...
    enableSliders: function() {
      ...
      dojo.removeClass(query("#price-filter")[0],"disabled");
  ...
  return tui.filterBPanel.view.BudgetToggle;
});