define("tui/overlaySearchB/OverlaySearchModal", [
    "dojo",
    "dojo/_base/lang",
    "dojo/_base/fx",
    'dojo/_base/connect',
    ...
    "tui/searchBGetPrice/view/GetPriceModal"], function (dojo, lang, fx, connect, query, Observable, AirportModel, AirportMultiFieldStore, DestinationModel, DestinationMultiFieldStore) {

    dojo.declare("tui.overlaySearchB.OverlaySearchModal", [tui.searchBGetPrice.view.GetPriceModal], {
    ...
    return tui.overlaySearchB.OverlaySearchModal;
});
