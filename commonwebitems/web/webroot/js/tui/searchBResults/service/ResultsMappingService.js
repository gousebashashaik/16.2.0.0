define("tui/searchBResults/service/ResultsMappingService", ["dojo/_base/lang"], function (lang) {
  ...
  return {
    mapResponse: function (previousData, responseData, field, newValue) {
     ...
     var repaint = hasFilters ? responseData.searchResult.filterPanel.repaint : '';
	  ...
	  // DE36168 - to update the newly obtained value null check has been placed
      if (hasFilters && !responseData.searchResult.filterPanel.totalbudget && !responseData.searchResult.filterPanel.ppbudget) {
