define("tui/searchBResults/view/NoResultView", [
  "dojo",
  "dojo/on",
  "dojo/query",
  "tui/utils/AjaxQueue",
  "dojo/text!tui/searchBResults/view/templates/noResultsAltSearchTmpl.html",
  "dojo/io-query",
  ...
  dojo.declare("tui.searchBResults.view.NoResultView", [tui.widget._TuiBaseWidget, tui.widget.mixins.Templatable], {
    ...
    parseData: function (response, options) {
      ...
      switch (options.widenType) {
        case "WHERETO":
          from = (!response.searchRequest.airports.length) ? "Any UK Airport" : response.searchRequest.airports[0].name;
  ...
  return tui.searchBResults.view.NoResultView;
});