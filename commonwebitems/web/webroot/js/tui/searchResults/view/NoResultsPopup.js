define("tui/searchResults/view/NoResultsPopup", ["dojo", "dojo/on", "dojo/_base/connect", "tui/widget/popup/DynamicPopup"], function (dojo, on) {

  dojo.declare("tui.searchResults.view.NoResultsPopup", [tui.widget.popup.DynamicPopup], {
  ...
  return tui.searchResults.view.NoResultsPopup;
});