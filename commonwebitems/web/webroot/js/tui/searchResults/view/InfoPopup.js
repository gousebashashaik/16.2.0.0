define("tui/searchResults/view/InfoPopup", [
    "dojo",
    "dojo/on",
    "dojo/cookie",
    "tui/widget/popup/ErrorPopup",
    "dojo/text!tui/searchResults/view/templates/infoPopupTmpl.html"], function (dojo, on, cookie, ErrorPopup, Tmpl) {

    dojo.declare("tui.searchResults.view.InfoPopup", [tui.widget.popup.ErrorPopup], {
    ...
    return tui.searchResults.view.InfoPopup;
});