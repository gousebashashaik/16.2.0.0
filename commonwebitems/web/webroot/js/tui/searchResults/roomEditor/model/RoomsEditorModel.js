define("tui/searchResults/roomEditor/model/RoomsEditorModel", [
  "dojo",
  "dojo/Stateful",
  "dojo/store/Observable",
  "tui/searchResults/roomEditor/store/RoomsStore",
  "tui/search/model/SearchModel",
  "tui/search/base/PartyCompositionBase"], function (dojo, Stateful, Observable, RoomsStore) {

  dojo.declare("tui.searchResults.roomEditor.model.RoomsEditorModel", [tui.search.model.SearchModel, tui.search.base.PartyCompositionBase], {
    ...
    validateRoomChildAges: function (room) {
      ...
      if (_.filter(room.childAges,function (age) {
        ...
        dojo.publish("tui/search/model/ChildAges/Errors");
  ...
  return tui.searchResults.roomEditor.model.RoomsEditorModel;
});