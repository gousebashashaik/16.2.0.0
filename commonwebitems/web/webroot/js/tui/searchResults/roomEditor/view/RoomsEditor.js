define("tui/searchResults/roomEditor/view/RoomsEditor", [
    "dojo",
    "dojo/_base/declare",
    "dojo/on",
    "dojo/topic",
    "dojo/text!tui/searchResults/roomEditor/view/templates/roomOptionsTmpl.html",
    "tui/widget/form/SelectOption",
    "tui/searchResults/roomEditor/view/RoomUnit",
    "tui/searchResults/roomEditor/model/RoomModel",
    "tui/widget/mixins/Templatable",
    "tui/widget/_TuiBaseWidget",
    "tui/search/nls/Searchi18nable"], function (dojo, declare, on, topic, roomOptionsTmpl, SelectOption, RoomUnit, RoomModel) {

    return declare("tui.searchResults.roomEditor.view.RoomsEditor", [tui.widget._TuiBaseWidget, tui.widget.mixins.Templatable, tui.search.nls.Searchi18nable], {
        ...
        refresh: function (field, oldValue, newValue, response) {
            ...
            if (field === "rooms" && response.searchResult.endecaResultsCount > 0) {
                ...
                topic.publish("tui.searchResults.roomEditor.view.RoomsPopup.close");
                // publish rooms to room summary view
                topic.publish("tui.searchResults.roomEditor.view.RoomsSummary.renderSummary", roomsEditor.getFormattedRooms());
            }
        ...
        handleNoResults: function (name, oldResults, newResults) {
            ...
            if (name === 'rooms') {
                ...
                topic.publish("tui.searchResults.roomEditor.view.RoomsPopup.resize");
                roomsEditor.undo();
            }
        },
        ...
        undo: function () {
            ...
            if (size === 0) {
                ...
                topic.publish("tui.searchResults.roomEditor.view.RoomsSummary.revert");
            } else {
        ...
        postCreate: function () {
            ...
            roomsEditor.subscribe("tui/searchResults/roomEditor/view/RoomsEditor/removeError", function (key) {
                if (key === "childNoAges") {
                    topic.publish("tui/search/model/ChildAges/Errors", [
                        {id: 0}
                    ]);
                }
            ...
            if( dojoConfig.site == "cruise"){
            	roomsEditor.tagElement(roomsEditor.searchButton, "searchAgain");
	            roomsEditor.tagElement(roomsEditor.numRoomsSelectOption.domNode, "numberOfCabins");
	            var undoEle = dojo.query(".no-results-options .options li a.undo", roomsEditor.domNode)[0];
	            dojo.setAttr(undoEle, {"analytics-id": roomsEditor.tag, "analytics-instance": "1", "analytics-text": "lastselectionUndo"});
	            var resetEle = dojo.query(".no-results-options .options li a.reset", roomsEditor.domNode)[0];
	            dojo.setAttr(resetEle, {"analytics-id": roomsEditor.tag, "analytics-instance": "1", "analytics-text": "removemySelection"});
            }else{
        ...
        initRoomsSelectOption: function () {
            ...
            roomsEditor.numRoomsSelectOption.subscribe("tui/searchPanel/searchOpening", function (component) {
        ...
        displayErrorMessages: function (name, oldError, newError) {
            ...
            if (name === "partyComp") topic.publish("tui/searchResults/roomEditor/view/RoomsEditor/Errors/Party", true);
            if (name === "roomOccupancy") topic.publish("tui/searchResults/roomEditor/model/roomNotOccupied", true);
        ...
        removeErrorMessages: function (name, oldError, newError) {
            ...
            if (name === "partyComp") topic.publish("tui/searchResults/roomEditor/view/RoomsEditor/Errors/Party", false);
            if (name === "roomOccupancy") topic.publish("tui/searchResults/roomEditor/model/roomNotOccupied", false);

            topic.publish("tui/searchResults/roomEditor/view/RoomsEditor/removeError", [key]);

            // publish to infant selectOptions > remove error class if guilty
            if (key === "infantLimit") topic.publish("tui/searchResults/roomEditor/view/RoomsEditor/Errors/InfantLimit", false);
