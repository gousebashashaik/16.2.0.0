define("tui/searchResults/roomEditor/view/PartyCompSelectOption", [
  "dojo",
  "dojo/on",
  "tui/widget/form/SelectOption"], function (dojo, on) {

  dojo.declare("tui.searchResults.roomEditor.view.PartyCompSelectOption", [tui.widget.form.SelectOption], {
    ...
    postCreate: function () {
      ...
      partyCompSelectOption.subscribe("tui/searchResults/roomEditor/model/roomNotOccupied", function (action) {
  ...
  return tui.searchResults.roomEditor.view.PartyCompSelectOption;
});