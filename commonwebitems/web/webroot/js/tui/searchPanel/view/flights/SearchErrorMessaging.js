define("tui/searchPanel/view/flights/SearchErrorMessaging", [
  "dojo",
  "tui/searchPanel/view/ErrorPopup"], function (dojo, ErrorPopup) {

  dojo.declare("tui.searchPanel.view.flights.SearchErrorMessaging", null, {
    ...
    addTags: function (key) {
      ...
      switch (key) {
        case "emptyFromTo":
          ...
          break;
        case "emptyTo":
            analyticsText = "Arrival Airport Error";
            break;
        case "emptyDate":
          analyticsText = "Departure Date Error";
          break;
        case "ToDategtFromDate":
            analyticsText = "Departure Date Error";
            break;
        case "childNoAges":
        ...
        case "childOnly":
          analyticsText = "Child Error";
          break;
        case "invalidDepartureAirportCombination":
            analyticsText = "invalidDepartureAirportCombination Error";
            break;
        case "invalidArrivalAirportCombination":
            analyticsText = "invalidArrivalAirportCombination Error";
            break;
        case "invalidDepartureandArrivalAirportCombination":
            analyticsText = "invalidDepartureandArrivalAirportCombination Error";
            break;
        case "invalidFromAndToFlyingCombination":
            analyticsText = "invalidFromAndToFlyingCombination Error";
            break; 
        default:
  ...
  return tui.searchPanel.view.flights.SearchErrorMessaging;
});