define("tui/searchPanel/view/flights/DestinationAutoComplete", [
  "dojo",
  "dojo/on",
  ...
  dojo.declare("tui.searchPanel.view.flights.DestinationAutoComplete", [tui.searchPanel.view.SearchAutoComplete,
    tui.search.nls.Searchi18nable], {
    ...
    onDisableSelection: function () {
      dojo.publish('tui.searchPanel.view.flights.flights.DestinationMultiFieldList.onTextboxInputFocus');
    },
    ...
    onEnterKey: function (event, domNode) {
      ...
      if (destinationAutocomplete.widgetController.searchApi === "searchPanel" && dojo.keys.TAB === (event.charCode || event.keyCode)) {
        ...
        dojo.publish("tui.searchPanel.view.flights.SearchDatePicker.focusCalendar", [destinationAutocomplete.widgetController]);
      }
    },
  ...
  return tui.searchPanel.view.flights.DestinationAutoComplete;
});
