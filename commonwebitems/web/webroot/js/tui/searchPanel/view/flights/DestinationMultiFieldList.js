define("tui/searchPanel/view/flights/DestinationMultiFieldList", ["dojo",
  "dojo/cookie",
  "dojo/on",
  ...
  "tui/searchPanel/view/flights/DestinationAutoComplete"
], function (dojo, cookie, on, strings, searchConfig, ErrorPopup, DestinationModel) {

  dojo.declare("tui.searchPanel.view.flights.DestinationMultiFieldList", [tui.searchPanel.view.SearchMultiFieldList], {
    ...
    displayToErrorMessage: function (name, oldErrorInfo, newErrorInfo) {
      ...
      on(destinationMultiFieldList.infoPopup.popupDomNode, on.selector('.airport-guide', "click"), function (event) {
        ...
        dojo.publish("tui.searchPanel.view.flights.AirportGuide.openExpandable");
    ...
    onTextboxInputFocus: function (event) {
      ...
      dojo.publish("tui.searchPanel.view.flights.AirportMultiFieldList.onTextboxInputBlur");
  ...
  return tui.searchPanel.view.flights.DestinationMultiFieldList;
});
