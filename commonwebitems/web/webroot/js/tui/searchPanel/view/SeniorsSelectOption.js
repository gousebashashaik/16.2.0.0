define("tui/searchPanel/view/SeniorsSelectOption", [
	"dojo",
	"tui/searchPanel/view/PartyCompSelectOption"], function (dojo) {


	dojo.declare("tui.searchPanel.view.SeniorsSelectOption", [tui.searchPanel.view.PartyCompSelectOption], {
	...
	return tui.searchPanel.view.SeniorsSelectOption;
});
