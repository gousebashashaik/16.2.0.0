define("tui/searchPanel/view/AirportMultiFieldList", [
  "dojo",
  "dojo/on",
  ...
  dojo.declare("tui.searchPanel.view.AirportMultiFieldList", [tui.searchPanel.view.SearchMultiFieldList,
    tui.searchPanel.view.SearchErrorMessaging], {
    ...
    displayRouteError: function (name, oldError, newError) {
      ...
      on(airportMultiFieldList.infoPopup.popupDomNode, on.selector('.airport-guide', "click"), function (event) {
        ...
        dojo.publish("tui.searchPanel.view.AirportGuide.openGlobalExpandable", [airportMultiFieldList.widgetController]);
      ...
      on(airportMultiFieldList.infoPopup.popupDomNode, on.selector('.datepicker', "click"), function (event) {
        ...
        // open datepicker
        dojo.publish("tui.searchPanel.view.SearchDatePicker.onCalendarFocus", airportMultiFieldList.widgetController.searchApi);
      });
    },
  ...
  return tui.searchPanel.view.AirportMultiFieldList;
});
