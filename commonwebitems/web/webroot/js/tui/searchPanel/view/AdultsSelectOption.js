define("tui/searchPanel/view/AdultsSelectOption", [
  "dojo",
  "tui/searchPanel/view/PartyCompSelectOption"], function (dojo) {

  dojo.declare("tui.searchPanel.view.AdultsSelectOption", [tui.searchPanel.view.PartyCompSelectOption], {
  ...
  return tui.searchPanel.view.AdultsSelectOption;
});