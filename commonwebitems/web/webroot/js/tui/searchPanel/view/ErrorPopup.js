define("tui/searchPanel/view/ErrorPopup", [
  "dojo",
  "tui/widget/popup/ErrorPopup",
  "dojo/text!tui/searchPanel/view/templates/error.html"], function (dojo, ErrorPopup, Tmpl) {

  dojo.declare("tui.searchPanel.view.ErrorPopup", [tui.widget.popup.ErrorPopup], {
  ...
  return tui.searchPanel.view.ErrorPopup;
});