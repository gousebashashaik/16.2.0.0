define("tui/searchPanel/view/SearchMultiFieldList", ["dojo",
  "dojo/cookie",
  "dojo/on",
  ...
  "tui/search/nls/Searchi18nable"], function (dojo, cookie, on, SearchErrorPopup, searchConfig, hasCssProp) {

  dojo.declare("tui.searchPanel.view.SearchMultiFieldList", [tui.widget.form.MultiFieldList,
  ...
  return tui.searchPanel.view.SearchMultiFieldList;
});
