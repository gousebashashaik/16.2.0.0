define("tui/searchPanel/view/DestinationMultiFieldList", ["dojo",
  "dojo/cookie",
  "dojo/on",
  ...
  dojo.declare("tui.searchPanel.view.DestinationMultiFieldList", [tui.searchPanel.view.SearchMultiFieldList], {
    ...
    displayToErrorMessage: function (name, oldErrorInfo, newErrorInfo) {
      ...
      on(destinationMultiFieldList.infoPopup.popupDomNode, on.selector('.datepicker', "click"), function (event) {
        ...
        // open datepicker
        dojo.publish("tui.searchPanel.view.SearchDatePicker.onCalendarFocus", destinationMultiFieldList.widgetController.searchApi);
      });
    },
  ...
  return tui.searchPanel.view.DestinationMultiFieldList;
});
