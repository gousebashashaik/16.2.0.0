define("tui/searchPanel/view/SearchSummary", [
  "dojo",
  "dojo/on",
  "dojo/dom-attr",
  'dojo/topic',
  ...
  dojo.declare("tui.searchPanel.view.SearchSummary", [tui.widget._TuiBaseWidget, tui.search.nls.Searchi18nable], {
    ...
    getPrintSummary: function (fieldName) {
      ...
      _.each(searchSummary.searchPanelModel[fieldName].getStorageData(["name"]), function (item) {
        text.push(item.name);
      });
  ...
  return tui.searchPanel.view.SearchSummary;
});