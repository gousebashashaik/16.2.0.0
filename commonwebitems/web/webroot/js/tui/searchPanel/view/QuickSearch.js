define("tui/searchPanel/view/QuickSearch", [
  "dojo",
  ...
  dojo.declare("tui.searchPanel.view.QuickSearch", [tui.widget.form.AutoComplete], {
    // summary:
    ...
    analyticText:"destinationQuickSearch",
    ...
    createListElement: function() {
      ...
      autoCompleteable.tagElements(dojo.query(autoCompleteable.domNode), autoCompleteable.analyticText);
    },
  ...
  return tui.searchPanel.view.QuickSearch;
});
