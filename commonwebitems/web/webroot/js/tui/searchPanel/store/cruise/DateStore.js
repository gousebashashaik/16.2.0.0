define("tui/searchPanel/store/cruise/DateStore", [
  "dojo",
  "dojo/io-query",
  ...
  dojo.declare("tui.searchPanel.store.cruise.DateStore", [tui.search.store.SearchPanelMemory], {
  ...
  return tui.searchPanel.store.cruise.DateStore;
});
