define("tui/searchPanel/store/AirportGuideStore", ["dojo",
    "dojo/io-query",
    "tui/search/store/SearchPanelMemory"], function (dojo, ioQuery) {

    dojo.declare("tui.searchPanel.store.AirportGuideStore", [tui.search.store.SearchPanelMemory], {
    ...
    return tui.searchPanel.store.AirportGuideStore;
});