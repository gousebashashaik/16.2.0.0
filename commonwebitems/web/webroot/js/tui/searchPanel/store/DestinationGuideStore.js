define("tui/searchPanel/store/DestinationGuideStore", [
    "dojo",
    "dojo/io-query",
    "tui/search/store/SearchPanelMemory",
    "dojo/store/Observable"], function (dojo, ioQuery, Store, Observable) {

    dojo.declare("tui.searchPanel.store.DestinationGuideStore", [tui.search.store.SearchPanelMemory], {
    ...
    return tui.searchPanel.store.DestinationGuideStore;
});
