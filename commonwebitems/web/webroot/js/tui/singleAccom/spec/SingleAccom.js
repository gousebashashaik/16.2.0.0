describe("Single Accommodation Spec", function () {
    var controller;

    beforeEach(function () {
        controller = new dojo.require("tui/singleAccom/Controller")();
    });
    ...
    it("Should Group Holidays by depature dates", function () {
    ...
    it("Should group holidays by depature Airports", function () {
