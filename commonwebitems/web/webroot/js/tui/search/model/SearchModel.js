define("tui/search/model/SearchModel", [
	"dojo",
	"dojo/Stateful",
	...
	dojo.declare("tui.search.model.SearchModel", [dojo.Stateful, tui.search.nls.Searchi18nable, tui.search.base.SearchValidationBase], {
      ...
      try {
		...
		retrieveSavedObject: function (airportStore) {
			...
			if (savedSearch.timestamp &&
					(new Date()).getTime() - savedSearch.timestamp > 1000 * 60 * 60 * 24 * searchModel.searchConfig.PERSISTED_SEARCH_PERIOD) {
	...
	return tui.search.model.SearchModel;
});