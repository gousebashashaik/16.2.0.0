define("tui/flights/timetable/TimeTableFlyToAutoSuggest", [
	"dojo",
	"dojo/text!tui/widget/form/flights/templates/statusAutoCompTmp.html",
	"dojo/on",
	"tui/flights/timetable/TimeTableFlyToAutoComplete",
    ...
    dojo.declare("tui.flights.timetable.TimeTableFlyToAutoSuggest", [tui.widget._TuiBaseWidget, dijit._TemplatedMixin, tui.widget.mixins.Scrollable, tui.utils.CancelBlurEventListener], {

        // ---------------------------------------------------------------- MultiFieldList Properties
    	 templateString: statusAutoCompTmp,

        autocomplete: tui.flights.timetable.TimeTableFlyToAutoComplete,
        ...
        createDownArrow: function(){
        	...
        	if(!_this.hasDownArrow){
        		...
        		on(_this.downArrow,"click",function(){
        			_this.autocomplete.targetURL =  dojoConfig.paths.webRoot + "/ws/timetablearrival?"+_this.autocomplete.getQueryObj();
    ...
    return tui.flights.timetable.TimeTableFlyToAutoSuggest;
});