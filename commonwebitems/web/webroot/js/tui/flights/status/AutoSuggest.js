define("tui/flights/status/AutoSuggest", [
	"dojo",
	"dojo/text!tui/widget/form/flights/templates/statusAutoCompTmp.html",
	"dojo/on",
	"tui/flights/status/FlightAutoComplete",
    ...
    dojo.declare("tui.flights.status.AutoSuggest", [tui.widget._TuiBaseWidget, dijit._TemplatedMixin, tui.widget.mixins.Scrollable, tui.utils.CancelBlurEventListener], {

        // ---------------------------------------------------------------- MultiFieldList Properties
    	 templateString: statusAutoCompTmp,

        autocomplete: tui.flights.status.FlightAutoComplete,
    ...
    return tui.flights.status.AutoSuggest;
});