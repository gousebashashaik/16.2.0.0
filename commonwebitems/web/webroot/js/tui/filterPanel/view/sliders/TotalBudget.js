define("tui/filterPanel/view/sliders/TotalBudget", [
  "dojo/_base/declare",
  "dojo/_base/lang",
  "dojo/topic",
  "tui/filterPanel/view/sliders/SlidingFilter"], function (declare, lang, topic) {

  return declare("tui.filterPanel.view.sliders.TotalBudget", [tui.filterPanel.view.sliders.SlidingFilter], {
    ...
    generateRequest: function (field) {
      ...
      request [filterId] = {
        ...
        max: max, //Math.ceil(slider.model.values[1]) || Math.ceil(slider.model.values[0]),
