define ("tui/widget/customeraccount/EditEmailPopup", [
        													"dojo",											  	
        													"dojo/cookie",
        													"dojo/query",
        													"dojo/has",
        							    			  ...
        							    			  ], function(dojo,cookie, query, has, validate,check, arrayUtil, domStyle, focusUtil, EditEmailTmpl, xhr,domForm,domClass){

		dojo.declare("tui.widget.customeraccount.EditEmailPopup", [tui.widget._TuiBaseWidget, tui.widget.mixins.Templatable, tui.widget.customeraccount.ErrorHandling], {
					...
					if(obj[0] != undefined){
						...
						switch (responsecode)
						{
							...
							case "FAILURE":
								...
								window.location = tuiWebrootPath+"/manageAccount/customerHome";
								break;
							case "SUCCESS":
	...
	return tui.widget.customeraccount.EditEmailPopup;
});