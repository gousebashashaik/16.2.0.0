define("tui/widget/customeraccount/popup/Popup", [
    "dojo",
    "dojo/on",
    "dojo/_base/fx",
    "dojo/query",
    ...
    dojo.declare("tui.widget.customeraccount.popup.Popup", [tui.widget.popup.PopupBase], {
        ...
        open: function () {
            ...
            if (popup.modal) {
				...
				if(dojo.byId('transferringToOtherTH').style.display=="block" || dojo.byId('transferringToOtherFC').style.display=="block" ){
					t=new dojox.timing.Timer(1000);
					t.start();
					document.location.href=popup.href;
				}
                return;
            }
    ...
    tui.widget.popup.Popup.Modal = (function () {
        ...
        function addPopup(popup) {
            var index = dojo.indexOf(popups, popup);
            if (index === -1) {
                popups.push(popup);
            }
        }
    ...
    return tui.widget.customeraccount.popup.Popup;
})