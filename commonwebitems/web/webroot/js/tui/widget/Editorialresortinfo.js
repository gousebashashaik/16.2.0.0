define("tui/widget/Editorialresortinfo", [
  "dojo",
  "dojo/_base/connect",
  "dojo/hash",
  "dojo/io-query",
  ...
  dojo.declare("tui.widget.Editorialresortinfo", [tui.widget.Pills], {
    postCreate: function () {
      var pills = this,
      ...
      topic.subscribe('tui:channel=pillStateChange', function(value){
        if(!pills.checkActiveTab(value)) {
          ...
          dojo.addClass(pills.selectStatefulTab(value), "plist");
        }
      });
    },
    ...
    selectStatefulTab: function (value) {
      var pills = this,
  		...
  		domStyle.set(tabHeading.domNode,"display","none");
  ...
  return tui.widget.Editorialresortinfo;
});