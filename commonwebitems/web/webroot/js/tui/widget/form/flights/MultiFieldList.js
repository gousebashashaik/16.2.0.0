define("tui/widget/form/flights/MultiFieldList", ["dojo",
    "dojo/text!tui/widget/form/multiField/template/multiFieldTmpl.html",
    "dojo/on",
    "tui/widget/form/flights/MultiFieldTextbox",
    ...
    dojo.declare("tui.widget.form.flights.MultiFieldList", [tui.widget._TuiBaseWidget, dijit._TemplatedMixin, tui.widget.mixins.Scrollable, tui.utils.CancelBlurEventListener], {
        ...
        attachTextboxlistEventListeners: function () {
            ...
            function keyboardDeleteTextbox(position) {
                ...
                if (position[0] === 0 && multiFieldList.textboxes.length > 0) {
                    ...
                    dojo.forEach(multiFieldList.textboxes, function (textbox) {
        ...
        isValidMatch: function (selectedData) {
            ...
            if (!multiFieldList.allowDuplicate) {
                var index = dojo.indexOf(multiFieldList.textboxvalues, selectedData.value);
                if (index > -1) {
                    multiFieldList.resetTextboxInput();
                    return false;
                }
