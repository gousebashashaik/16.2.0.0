define("tui/widget/form/flights/MultiFieldTextbox", ["dojo"], function(dojo) {

	dojo.declare("tui.widget.form.flights.MultiFieldTextbox", null, {
		...
		create : function(editTextField) {
			...
			multifieldtextbox.domNode.innerHTML = "<span>" + multifieldtextbox.getLabel() +"("+multifieldtextbox.getName()+")" + "</span>";
	...
	return tui.widget.form.flights.MultiFieldTextbox;
})