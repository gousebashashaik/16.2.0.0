define("tui/widget/expand/Expandable", [
  "dojo",
  ...
  dojo.declare("tui.widget.expand.Expandable", [tui.widget._TuiBaseWidget, tui.widgetFx.Transitiable], {
...
// if(expandable.autoTag) {
  ...
  return tui.widget.expand.Expandable;
});
