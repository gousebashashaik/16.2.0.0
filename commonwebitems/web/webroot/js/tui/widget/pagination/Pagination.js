define("tui/widget/pagination/Pagination",[
  ...
  function (declare, lang, Evented, domAttr, domClass, i18n, on, query, template, number, _TemplatedMixin, _WidgetBase) {
    declare("tui.widget.pagination.Pagination",[_WidgetBase, _TemplatedMixin, Evented], {
      // dijit HTML
      ...
      postCreate: function () {
        // setup connections
        on(this.listNode, '[data-page]:click', lang.hitch(this, function (evt) {
          if (!this.disabled) {
    ...
    return tui.widget.pagination.Pagination;
  });