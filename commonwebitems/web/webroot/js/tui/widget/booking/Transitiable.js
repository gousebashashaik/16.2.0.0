define("tui/widget/booking/Transitiable", ["dojo", "tui/widgetFx/TransitionFactory"], function(dojo){
	
	dojo.declare("tui.widget.booking.Transitiable", null , {
	...
	return tui.widget.booking.Transitiable;
})