define ("tui/widget/booking/Transition", ["dojo", "dojo/fx"], function(dojo){
	
	dojo.declare("tui.widget.booking.Transition", null , {
		...
		attachTransitionEventListeners: function(){
   		...
   		onWidgetTransitionEnd: function(transition, itemContent, item, wipe, target){
			...
			console.log("i am in here finally");
			wipe = wipe ? wipe : "";
	...
	return tui.widget.booking.Transition;
})