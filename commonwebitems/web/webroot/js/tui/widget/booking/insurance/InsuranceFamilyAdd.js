define(["dojo/_base/declare",
  ...
  "dojo/text!tui/widget/booking/insurance/view/templates/InsuranceFamAdd.html",
  ...
  function (declare, _WidgetBase, Templatable, dtlTemplated, dojo, lang, domConstruct, query, dom, on, event, domClass, domAttr, insuranceInformationOverlay, BookflowUrl,Bookflowi18nable,InsuranceModel,InsuranceFamAddTmpl, xhr) {
    return declare("tui.widget.booking.insurance.InsuranceFamilyAdd", [ _WidgetBase, dtlTemplated, Templatable, Bookflowi18nable ], {
      ...
      postMixInProperties: function () {
        ...
        InsuranceFamilyAdd.currency=dojoConfig.currency;
       ...
       // console.log(InsuranceFamilyAdd.indivtitle1,"InsuranceFamilyAdd.indivtitle1");
        ...
        InsuranceFamilyAdd.initBookflowMessaging();
        InsuranceFamilyAdd.setContentValues();
      ...
      postCreate: function () {
        ...
        var InsuranceFamilyAdd = this;
        InsuranceFamilyAdd.insuranceInformationOverlay = new tui.widget.booking.insurance.InsuranceInformationOverlay({
