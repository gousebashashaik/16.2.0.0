define(["dojo/_base/declare",
  ...
  "dojo/text!tui/widget/booking/insurance/view/templates/InsuranceIndividualCover.html",
  ...
  function (declare, _WidgetBase, Templatable, dtlTemplated, dojo, lang, domConstruct, query, dom, on,domClass, domStyle, insuranceInformationOverlay, individualDetailsTmpl,insuranceModel) {
    return declare("tui.widget.booking.insurance.InsuranceIndividualCover",
      [_WidgetBase, dtlTemplated, Templatable], {
        ...
        postMixInProperties: function () {
          ...
          insuranceIndividualCover.currency=dojoConfig.currency;
