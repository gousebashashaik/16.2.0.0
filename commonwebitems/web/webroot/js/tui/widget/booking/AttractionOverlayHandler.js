define('tui/widget/booking/AttractionOverlayHandler', [
  'dojo',
  'dojo/query',
  'dojo/dom-class'
], function(dojo, query, domClass) {

dojo.declare('tui.widget.booking.AttractionOverlayHandler', [tui.widget._TuiBaseWidget], {
	...
	return tui.widget.booking.AttractionOverlayHandler;
});