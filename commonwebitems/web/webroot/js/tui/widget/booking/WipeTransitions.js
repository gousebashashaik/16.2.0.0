define("tui/widget/booking/WipeTransitions", ["dojo", "dojo/dom-class", "dojo/_base/fx", "tui/widget/booking/Transition"], function(dojo, domClass, baseFx){
	
	/***********************************************************************************/
   	/* tui.widgetFx.WipeBase														   */
   	/***********************************************************************************/
	dojo.declare("tui.widgetFx.WipeBase", [tui.widget.booking.Transition], {
		...
		attachTransitionEventListeners: function(){
    		...
    		wipeBase.items.forEach(function(item, index){
    			...
    			if (target){
    				...
    				if (dojo.indexOf(wipeBase.defaultOpen, index + 1) !== -1){
   ...
   dojo.declare("tui.widgetFx.ComplexWipeBase", [tui.widgetFx.WipeBase], {
	...
	return tui.widget.booking.WipeTransitions;
})