define(["dojo/_base/declare","dojo/has",
  ...
  "dojo/text!tui/widget/booking/insuranceB/view/templates/InsuranceIndAddDetails.html",
  ...
  "tui/widget/booking/insuranceB/TravelInsuranceComponent","tui/widget/booking/insuranceB/InsuranceIndAdd"],
  function (declare, has,_WidgetBase, Templatable, dtlTemplated, dojo, lang, domConstruct, query, dom, on, event, xhr, domClass, domAttr, insuranceInformationOverlay, BookflowUrl,insuranceIndAddTmpl,InsuranceModel) {
    return declare("tui.widget.booking.insuranceB.InsuranceIndAddDetails",
      [_WidgetBase, dtlTemplated, Templatable], {
        ...
        postMixInProperties: function () {
         ...
         // insuranceIndAddDetails.map2 = this.mapobj2;
          ...
          insuranceIndAddDetails.excesswaiverDisplay = this.excesswaiverDisplay;
        ...
        postCreate: function () {
          ...
          insuranceIndAddDetails.insuranceInformationOverlay = new tui.widget.booking.insuranceB.InsuranceInformationOverlay({widgetId: 'insuranceIndAdd', modal: true});
        ...
        afterSuccess: function (response) {
         ...
         /* var index = controller.views.indexOf(this);
          ...
          console.log(insuranceIndAddDetails.addExcessFlag,"insuranceIndAddDetails.addExcessFlag");
          	...
          	InsuranceModel.insuranceJsonData = response;
          //var newInstance = new tui.widget.booking.insuranceB.TravelInsuranceComponent({'jsonData': response});
       ...
       // if(has("ie")){
          var insuranceIndAdd = new tui.widget.booking.insuranceB.InsuranceIndAdd({
