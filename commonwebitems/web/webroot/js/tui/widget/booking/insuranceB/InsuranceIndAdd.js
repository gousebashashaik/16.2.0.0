define(["dojo/_base/declare",
  ...
  "dojo/text!tui/widget/booking/insuranceB/view/templates/InsuranceIndAdd.html",
  "dojo/_base/xhr",
  ...
  function (declare, _WidgetBase, Templatable, dtlTemplated, dojo, lang, domConstruct, query, dom, on, array,
    ...
    return declare("tui.widget.booking.insuranceB.InsuranceIndAdd", [_WidgetBase, dtlTemplated, Templatable], {
      ...
      postCreate: function () {
        var insuranceIndAdd = this;
        insuranceIndAdd.insuranceInformationOverlay = new tui.widget.booking.insuranceB.InsuranceInformationOverlay({widgetId: 'insuranceIndAdd', modal: true});
