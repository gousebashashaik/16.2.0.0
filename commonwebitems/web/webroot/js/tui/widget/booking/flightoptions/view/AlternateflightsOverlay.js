define("tui/widget/booking/flightoptions/view/AlternateflightsOverlay", [
  "dojo/_base/declare",
  "dojo/query",
  "dojo/topic",
  "dojo/_base/lang",
  "tui/widget/booking/utils/BookFlowDynamicPopup"], function (declare, query, topic, lang, DynamicPopup) {

  return declare("tui.widget.booking.flightoptions.view.AlternateflightsOverlay", [DynamicPopup], {
