define("tui/widget/datepicker/DatePickerOld", ["dojo",
                ...
                dojo.declare("tui.widget.datepicker.DatePicker", [tui.widget._TuiBaseWidget, 
                                ...
                                postCreate: function () {
                                                ...
                                                datePicker.selectedDate = daysAhead;
                                ...
                                combineMonthsAndYears: function () {
                                                ...
                                                var seasonLength = datePicker.seasonLength || (datePicker.yearRange * 12) - (datePicker.datePickerShowDate.getMonth() + 1);
                                ...
                                disableUnavailableDates: function (date, past) {
                                                ...
                                                if (datePicker.datePickerShowDate.getMonth() === date.getMonth() &&
                                                                ...
                                                                datePicker.disablePastDatesByIndex();
                                                }
                                },
                                ...
                                setDateSelectOption: function () {
                                                var datePicker = this;
                                                var monthAndYear = [(datePicker.datePickerShowDate.getMonth() + 1), '/', datePicker.datePickerShowDate.getFullYear()].join('');
