...
// version: 3.0.5
(function(e){Function.prototype.bind||(Function.prototype.bind=function(c){var a=[].slice,b=a.call(arguments,1),d=this,g=function(){},f=function(){return d.apply(this instanceof g?this:c||{},b.concat(a.call(arguments)))};g.prototype=d.prototype;f.prototype=new g;return f});"undefined"===typeof e.Code&&(e.Code={});e.Code.Util={registerNamespace:function(){var c=arguments,a=null,b,d,g,f,l;b=0;for(f=c.length;b<f;b++)for(g=c[b],g=g.split("."),a=g[0],"undefined"===typeof e[a]&&(e[a]={}),a=e[a],d=1,l=g.length;d<
l;++d)a[g[d]]=a[g[d]]||{},a=a[g[d]]},coalesce:function(){var c,a;c=0;for(a=arguments.length;c<a;c++)if(!this.isNothing(arguments[c]))return arguments[c];return null},extend:function(c,a,b){var d;this.isNothing(b)&&(b=!0);if(c&&a&&this.isObject(a))for(d in a)this.objectHasProperty(a,d)&&(b?c[d]=a[d]:"undefined"===typeof c[d]&&(c[d]=a[d]))},clone:function(c){var a={};this.extend(a,c);return a},isObject:function(c){return c instanceof Object},isFunction:function(c){return"[object Function]"==={}.toString.call(c)},
...
"")})},toDashedCase:function(c){return c.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()})},arrayIndexOf:function(c,a,b){var d,g,f,e;f=-1;d=0;for(g=a.length;d<g;d++)if(e=a[d],!this.isNothing(b)){if(this.objectHasProperty(e,b)&&e[b]===c){f=d;break}}else if(e===c){f=d;break}return f},objectHasProperty:function(c,a){return c.hasOwnProperty?c.hasOwnProperty(a):"undefined"!==typeof c[a]}}})(window);
...
document.createElement(this._eventTagNames[a]||"div"),d;a="on"+a;d=c.objectHasProperty(b,a);d||(b.setAttribute(a,"return;"),d="function"===typeof b[a]);return d},isLandscape:function(){return c.DOM.windowWidth()>c.DOM.windowHeight()}};c.Browser._detect()})(window,window.Code.Util);
(function(e,c){c.extend(c,{Events:{add:function(a,b,d){this._checkHandlersProperty(a);"mousewheel"===b&&(b=this._normaliseMouseWheelType());"undefined"===typeof a.__eventHandlers[b]&&(a.__eventHandlers[b]=[]);a.__eventHandlers[b].push(d);this._isBrowserObject(a)&&a.addEventListener(b,d,!1)},remove:function(a,b,d){this._checkHandlersProperty(a);"mousewheel"===b&&(b=this._normaliseMouseWheelType());if(a.__eventHandlers[b]instanceof Array){var g,f,e=a.__eventHandlers[b];if(c.isNothing(d)){if(this._isBrowserObject(a))for(g=
0,f=e.length;g<f;g++)a.removeEventListener(b,e[g],!1);a.__eventHandlers[b]=[]}else{g=0;for(f=e.length;g<f;g++)if(e[g]===d){e.splice(g,1);break}this._isBrowserObject(a)&&a.removeEventListener(b,d,!1)}}},fire:function(a,b){var d,g,f,l,k=Array.prototype.slice.call(arguments).splice(2);"mousewheel"===b&&(b=this._normaliseMouseWheelType());if(this._isBrowserObject(a)){if("string"!==typeof b)throw"type must be a string for DOM elements";f=this._NATIVE_EVENTS[b];d=document.createEvent(f?"HTMLEvents":"UIEvents");
d[f?"initEvent":"initUIEvent"](b,!0,!0,e,1);if(1>k.length){a.dispatchEvent(d);return}}this._checkHandlersProperty(a);d="string"===typeof b?{type:b}:b;d.target||(d.target=a);if(!d.type)throw Error("Event object missing 'type' property.");if(a.__eventHandlers[d.type]instanceof Array)for(f=a.__eventHandlers[d.type],k.unshift(d),d=0,g=f.length;d<g;d++)l=f[d],c.isNothing(l)||l.apply(a,k)},getMousePosition:function(a){var b={x:0,y:0};a.pageX?b.x=a.pageX:a.clientX&&(b.x=a.clientX+(document.documentElement.scrollLeft||
...
(function(e,c){c.extend(c,{DOM:{setData:function(a,b,d){if(c.isLikeArray(a)){var g,f;g=0;for(f=a.length;g<f;g++)c.DOM._setData(a[g],b,d)}else c.DOM._setData(a,b,d)},_setData:function(a,b,d){c.DOM.setAttribute(a,"data-"+b,d)},getData:function(a,b,d){return c.DOM.getAttribute(a,"data-"+b,d)},removeData:function(a,b){if(c.isLikeArray(a)){var d,g;d=0;for(g=a.length;d<g;d++)c.DOM._removeData(a[d],b)}else c.DOM._removeData(a,b)},_removeData:function(a,b){c.DOM.removeAttribute(a,"data-"+b)},isChildOf:function(a,
b){if(b===a)return!1;for(;a&&a!==b;)a=a.parentNode;return a===b},find:function(a,b){c.isNothing(b)&&(b=e.document);var d=b.querySelectorAll(a),g=[],f,l;f=0;for(l=d.length;f<l;f++)g.push(d[f]);return g},createElement:function(a,b,d){var g;a=document.createElement(a);for(g in b)c.objectHasProperty(b,g)&&a.setAttribute(g,b[g]);a.innerHTML=d||"";return a},appendChild:function(a,b){b.appendChild(a)},insertBefore:function(a,b,d){d.insertBefore(a,b)},appendText:function(a,b){c.DOM.appendChild(document.createTextNode(a),
b)},appendToBody:function(a){this.appendChild(a,document.body)},removeChild:function(a,b){b.removeChild(a)},removeChildren:function(a){if(a.hasChildNodes())for(;1<=a.childNodes.length;)a.removeChild(a.childNodes[a.childNodes.length-1])},hasAttribute:function(a,b){return!c.isNothing(a.getAttribute(b))},getAttribute:function(a,b,d){a=a.getAttribute(b);c.isNothing(a)&&!c.isNothing(d)&&(a=d);return a},setAttribute:function(a,b,d){if(c.isLikeArray(a)){var g,f;g=0;for(f=a.length;g<f;g++)c.DOM._setAttribute(a[g],
b,d)}else c.DOM._setAttribute(a,b,d)},_setAttribute:function(a,b,d){a.setAttribute(b,d)},removeAttribute:function(a,b){if(c.isLikeArray(a)){var d,g;d=0;for(g=a.length;d<g;d++)c.DOM._removeAttribute(a[d],b)}else c.DOM._removeAttribute(a,b)},_removeAttribute:function(a,b){this.hasAttribute(a,b)&&a.removeAttribute(b)},addClass:function(a,b){if(c.isLikeArray(a)){var d,g;d=0;for(g=a.length;d<g;d++)c.DOM._addClass(a[d],b)}else c.DOM._addClass(a,b)},_addClass:function(a,b){var d=c.DOM.getAttribute(a,"class",
"");RegExp("(?:^|\\s+)"+b+"(?:\\s+|$)").test(d)||(""!==d&&(d+=" "),c.DOM.setAttribute(a,"class",d+b))},removeClass:function(a,b){if(c.isLikeArray(a)){var d,g;d=0;for(g=a.length;d<g;d++)c.DOM._removeClass(a[d],b)}else c.DOM._removeClass(a,b)},_removeClass:function(a,b){var d=c.DOM.getAttribute(a,"class",""),d=c.trim(d).split(" "),g="",f,e;f=0;for(e=d.length;f<e;f++)d[f]!==b&&(""!==g&&(g+=" "),g+=d[f]);""===g?c.DOM.removeAttribute(a,"class"):c.DOM.setAttribute(a,"class",g)},hasClass:function(a,b){return RegExp("(?:^|\\s+)"+
b+"(?:\\s+|$)").test(c.DOM.getAttribute(a,"class",""))},setStyle:function(a,b,d){if(c.isLikeArray(a)){var g,f;g=0;for(f=a.length;g<f;g++)c.DOM._setStyle(a[g],b,d)}else c.DOM._setStyle(a,b,d)},_setStyle:function(a,b,d){var g;if(c.isObject(b))for(g in b)c.objectHasProperty(b,g)&&("width"===g?c.DOM.width(a,b[g]):"height"===g?c.DOM.height(a,b[g]):a.style[g]=b[g]);else a.style[b]=d},getStyle:function(a,b){var d=e.getComputedStyle(a,"").getPropertyValue(b);""===d&&(d=a.style[b]);return d},hide:function(a){if(c.isLikeArray(a)){var b,
...
"height")},_getDimension:function(a,b){var d,g,c=e.parseInt(e.getComputedStyle(a,"").getPropertyValue(b));isNaN(c)&&(d=a.style.display,g=a.style.left,a.style.display="block",a.style.left="-1000000px",c=e.parseInt(e.getComputedStyle(a,"").getPropertyValue(b)),a.style.display=d,a.style.left=g);return c},outerHeight:function(a){var b=c.DOM.height(a),b=b+(parseInt(c.DOM.getStyle(a,"padding-top"),10)+parseInt(c.DOM.getStyle(a,"padding-bottom"),10)),b=b+(parseInt(c.DOM.getStyle(a,"margin-top"),10)+parseInt(c.DOM.getStyle(a,
...
"MozTransform":"transform",transformLabel:function(){return this._transformLabel},_getTransitionEndHandler:function(){c.isNothing(this._transitionEndHandler)&&(this._transitionEndHandler=this._onTransitionEnd.bind(this));return this._transitionEndHandler},stop:function(a){if(c.Browser.isCSSTransformSupported){var b={};c.Events.remove(a,this._transitionEndLabel,this._getTransitionEndHandler());c.isNothing(a.callbackLabel)&&delete a.callbackLabel;b[this._transitionPrefix+"Property"]="";b[this._transitionPrefix+
"Duration"]="";b[this._transitionPrefix+"TimingFunction"]="";b[this._transitionPrefix+"Delay"]="";b[this._transformLabel]="";c.DOM.setStyle(a,b)}else c.isNothing(e.jQuery)||e.jQuery(a).stop(!0,!0)},fadeIn:function(a,b,d,g,f){f=c.coalesce(f,1);0>=f&&(f=1);if(0>=b&&(c.DOM.setStyle(a,"opacity",f),!c.isNothing(d))){d(a);return}1<=c.DOM.getStyle(a,"opacity")&&c.DOM.setStyle(a,"opacity",0);c.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",f,b,d,g):c.isNothing(e.jQuery)||e.jQuery(a).fadeTo(b,
f,d)},fadeTo:function(a,b,d,g,c){this.fadeIn(a,d,g,c,b)},fadeOut:function(a,b,d,g){if(0>=b&&(c.DOM.setStyle(a,"opacity",0),!c.isNothing(d))){d(a);return}c.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",0,b,d,g):e.jQuery(a).fadeTo(b,0,d)},slideBy:function(a,b,d,g,f,l){var k={};b=c.coalesce(b,0);d=c.coalesce(d,0);l=c.coalesce(l,"ease-out");k[this._transitionPrefix+"Property"]="all";k[this._transitionPrefix+"Delay"]="0";0===g?(k[this._transitionPrefix+"Duration"]="",k[this._transitionPrefix+
"TimingFunction"]=""):(k[this._transitionPrefix+"Duration"]=g+"ms",k[this._transitionPrefix+"TimingFunction"]=c.coalesce(l,"ease-out"),c.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler()));k[this._transformLabel]=c.Browser.is3dSupported?"translate3d("+b+"px, "+d+"px, 0px)":"translate("+b+"px, "+d+"px)";c.isNothing(f)||(a.cclallcallback=f);c.DOM.setStyle(a,k);0===g&&e.setTimeout(function(){this._leaveTransforms(a)}.bind(this),this._applyTransitionDelay)},resetTranslate:function(a){var b=
{};b[this._transformLabel]=b[this._transformLabel]=c.Browser.is3dSupported?"translate3d(0px, 0px, 0px)":"translate(0px, 0px)";c.DOM.setStyle(a,b)},_applyTransition:function(a,b,d,g,f,l){var k={};l=c.coalesce(l,"ease-in");k[this._transitionPrefix+"Property"]=b;k[this._transitionPrefix+"Duration"]=g+"ms";k[this._transitionPrefix+"TimingFunction"]=l;k[this._transitionPrefix+"Delay"]="0";c.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler());c.DOM.setStyle(a,k);c.isNothing(f)||(a["ccl"+
b+"callback"]=f);e.setTimeout(function(){c.DOM.setStyle(a,b,d)},this._applyTransitionDelay)},_onTransitionEnd:function(a){c.Events.remove(a.currentTarget,this._transitionEndLabel,this._getTransitionEndHandler());this._leaveTransforms(a.currentTarget)},_leaveTransforms:function(a){var b=a.style[this._transitionPrefix+"Property"],d=""!==b?"ccl"+b+"callback":"cclallcallback",g,b=c.coalesce(a.style.webkitTransform,a.style.MozTransform,a.style.transform),f,l=e.parseInt(c.DOM.getStyle(a,"left"),0),k=e.parseInt(c.DOM.getStyle(a,
"top"),0),h,n,m={};""!==b&&(b=c.Browser.is3dSupported?b.match(/translate3d\((.*?)\)/):b.match(/translate\((.*?)\)/),c.isNothing(b)||(f=b[1].split(", "),h=e.parseInt(f[0],0),n=e.parseInt(f[1],0)));m[this._transitionPrefix+"Property"]="";m[this._transitionPrefix+"Duration"]="";m[this._transitionPrefix+"TimingFunction"]="";m[this._transitionPrefix+"Delay"]="";c.DOM.setStyle(a,m);e.setTimeout(function(){c.isNothing(f)||(m={},m[this._transformLabel]="",m.left=l+h+"px",m.top=k+n+"px",a.classList.contains("ps-carousel-content")&&
c.DOM.setStyle(a,m));c.isNothing(a[d])||(g=a[d],delete a[d],g(a))}.bind(this),this._applyTransitionDelay)}}})})(window,window.Code.Util);
...
y:a[0].pageY}},fireTouchEvent:function(b){var d=0,g=0,c=0,l,d=this.touchEndPoint.x-this.touchStartPoint.x,g=this.touchEndPoint.y-this.touchStartPoint.y,c=Math.sqrt(d*d+g*g);if(this.captureSettings.swipe&&(l=new Date,l-=this.touchStartTime,l<=this.swipeTimeThreshold)){if(e.Math.abs(d)>=this.swipeThreshold){a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:0>d?a.TouchElement.ActionTypes.swipeLeft:a.TouchElement.ActionTypes.swipeRight,targetEl:b.target,
currentTargetEl:b.currentTarget});return}if(e.Math.abs(g)>=this.swipeThreshold){a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:0>g?a.TouchElement.ActionTypes.swipeUp:a.TouchElement.ActionTypes.swipeDown,targetEl:b.target,currentTargetEl:b.currentTarget});return}}1<c?a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,action:a.TouchElement.ActionTypes.touchMoveEnd,point:this.touchEndPoint,targetEl:b.target,currentTargetEl:b.currentTarget}):
...
(function(e,c,a){a.registerNamespace("Code.PhotoSwipe.Image");var b=e.Code.PhotoSwipe;b.Image.ImageClass=c({refObj:null,imageEl:null,src:null,caption:null,metaData:null,imageLoadHandler:null,imageErrorHandler:null,dispose:function(){var d;this.shrinkImage();for(d in this)a.objectHasProperty(this,d)&&(this[d]=null)},initialize:function(a,b,c,l){this.refObj=a;this.src=this.originalSrc=b;this.caption=c;this.metaData=l;this.imageEl=new e.Image;this.imageLoadHandler=this.onImageLoad.bind(this);this.imageErrorHandler=
this.onImageError.bind(this)},load:function(){this.imageEl.originalSrc=a.coalesce(this.imageEl.originalSrc,"");this.imageEl.originalSrc===this.src?this.imageEl.isError?a.Events.fire(this,{type:b.Image.EventTypes.onError,target:this}):a.Events.fire(this,{type:b.Image.EventTypes.onLoad,target:this}):(this.imageEl.isError=!1,this.imageEl.isLoading=!0,this.imageEl.naturalWidth=null,this.imageEl.naturalHeight=null,this.imageEl.isLandscape=!1,this.imageEl.onload=this.imageLoadHandler,this.imageEl.onerror=
this.imageErrorHandler,this.imageEl.onabort=this.imageErrorHandler,this.imageEl.originalSrc=this.src,this.imageEl.src=this.src)},shrinkImage:function(){!a.isNothing(this.imageEl)&&-1<this.imageEl.src.indexOf(this.src)&&(this.imageEl.src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",a.isNothing(this.imageEl.parentNode)||a.DOM.removeChild(this.imageEl,this.imageEl.parentNode))},onImageLoad:function(d){this.imageEl.onload=null;this.imageEl.naturalWidth=a.coalesce(this.imageEl.naturalWidth,
this.imageEl.width);this.imageEl.naturalHeight=a.coalesce(this.imageEl.naturalHeight,this.imageEl.height);this.imageEl.isLandscape=this.imageEl.naturalWidth>this.imageEl.naturalHeight;this.imageEl.isLoading=!1;a.Events.fire(this,{type:b.Image.EventTypes.onLoad,target:this})},onImageError:function(d){this.imageEl.onload=null;this.imageEl.onerror=null;this.imageEl.onabort=null;this.imageEl.isLoading=!1;this.imageEl.isError=!0;a.Events.fire(this,{type:b.Image.EventTypes.onError,target:this})}})})(window,
window.klass,window.Code.Util);
(function(e,c,a){a.registerNamespace("Code.PhotoSwipe.Cache");e=e.Code.PhotoSwipe;e.Cache.Mode={normal:"normal",aggressive:"aggressive"};e.Cache.Functions={getImageSource:function(a){return a.href},getImageCaption:function(b){if("IMG"===b.nodeName)return a.DOM.getAttribute(b,"alt");var d,g,c;d=0;for(g=b.childNodes.length;d<g;d++)if(c=b.childNodes[d],"IMG"===b.childNodes[d].nodeName)return a.DOM.getAttribute(c,"alt")},getImageMetaData:function(a){return{}}}})(window,window.klass,window.Code.Util);
(function(e,c,a){a.registerNamespace("Code.PhotoSwipe.Cache");var b=e.Code.PhotoSwipe;b.Cache.CacheClass=c({images:null,settings:null,dispose:function(){var d,b,c;if(!a.isNothing(this.images)){b=0;for(c=this.images.length;b<c;b++)this.images[b].dispose();this.images.length=0}for(d in this)a.objectHasProperty(this,d)&&(this[d]=null)},initialize:function(a,g){var c,e,k,h,n,m;this.settings=g;this.images=[];c=0;for(e=a.length;c<e;c++)k=a[c],h=this.settings.getImageSource(k),n=this.settings.getImageCaption(k),
m=this.settings.getImageMetaData(k),this.images.push(new b.Image.ImageClass(k,h,n,m))},getImages:function(d){var g,c,e=[],k;g=0;for(c=d.length;g<c;g++)k=this.images[d[g]],this.settings.cacheMode===b.Cache.Mode.aggressive&&(k.cacheDoNotShrink=!0),e.push(k);if(this.settings.cacheMode===b.Cache.Mode.aggressive)for(g=0,c=this.images.length;g<c;g++)k=this.images[g],a.objectHasProperty(k,"cacheDoNotShrink")?delete k.cacheDoNotShrink:k.shrinkImage();return e}})})(window,window.klass,window.Code.Util,window.Code.PhotoSwipe.Image);
...
position:"absolute",left:0,top:0,zIndex:this.settings.zIndex});a.DOM.hide(this.el);this.settings.target===e?a.DOM.appendToBody(this.el):a.DOM.appendChild(this.el,this.settings.target);a.Animation.resetTranslate(this.el);this.initialBodyHeight=a.DOM.bodyOuterHeight()},resetPosition:function(){var d,b,c;this.settings.target===e?(d=a.DOM.windowWidth(),b=2*a.DOM.bodyOuterHeight(),c=this.settings.jQueryMobile?a.DOM.windowScrollTop()+"px":"0px",1>b&&(b=this.initialBodyHeight),a.DOM.windowHeight()>b&&(b=
a.DOM.windowHeight())):(d=a.DOM.width(this.settings.target),b=a.DOM.height(this.settings.target),c="0px");a.DOM.setStyle(this.el,{width:d,height:b,top:c})},fadeIn:function(b,g){this.resetPosition();a.DOM.setStyle(this.el,"opacity",0);a.DOM.show(this.el);a.Animation.fadeIn(this.el,b,g)}})})(window,window.klass,window.Code.Util);
...
this.imageLoadHandler),a.Events.remove(this.cache.images[g],b.Image.EventTypes.onError,this.imageErrorHandler);this.stopSlideshow();a.Animation.stop(this.el);a.DOM.removeChild(this.el,this.el.parentNode);for(d in this)a.objectHasProperty(this,d)&&(this[d]=null)},initialize:function(d,c){var f,l,k;this.cache=d;this.settings=c;this.slideByEndHandler=this.onSlideByEnd.bind(this);this.imageLoadHandler=this.onImageLoad.bind(this);this.imageErrorHandler=this.onImageError.bind(this);this.currentCacheIndex=
...
this.el);l=3>d.images.length?d.images.length:3;for(f=0;f<l;f++)k=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.item+" "+b.Carousel.CssClasses.item+"-"+f},""),a.DOM.setAttribute(k,"style","float: left;"),a.DOM.setStyle(k,{display:"block",position:"relative",left:0,top:0,overflow:"hidden"}),0<this.settings.margin&&a.DOM.setStyle(k,{marginRight:this.settings.margin+"px"}),a.DOM.appendChild(k,this.contentEl);this.settings.target===e?a.DOM.appendToBody(this.el):a.DOM.appendChild(this.el,this.settings.target)},
resetPosition:function(){var d,c,f,l,k,h;this.settings.target===e?(d=a.DOM.windowWidth(),c=a.DOM.windowHeight(),f=a.DOM.windowScrollTop()+"px"):(d=a.DOM.width(this.settings.target),c=a.DOM.height(this.settings.target),f="0px");l=0<this.settings.margin?d+this.settings.margin:d;k=a.DOM.find("."+b.Carousel.CssClasses.item,this.contentEl);l*=k.length;a.DOM.setStyle(this.el,{top:f,width:d,height:c});a.DOM.setStyle(this.contentEl,{width:l,height:c});f=0;for(l=k.length;f<l;f++)h=k[f],a.DOM.setStyle(h,{width:d,
height:c}),h=a.DOM.find("img",h)[0],a.isNothing(h)||this.resetImagePosition(h);this.setContentLeftPosition()},resetImagePosition:function(b){if(!a.isNothing(b)){a.DOM.getAttribute(b,"src");var c,f,e,k;k=a.DOM.width(this.el);var h=a.DOM.height(this.el);"fitNoUpscale"===this.settings.imageScaleMethod?(f=b.naturalWidth,e=b.naturalHeight,f>k&&(c=k/f,f=Math.round(f*c),e=Math.round(e*c)),e>h&&(c=h/e,e=Math.round(e*c),f=Math.round(f*c))):(c=b.isLandscape?k/b.naturalWidth:h/b.naturalHeight,f=Math.round(b.naturalWidth*
c),e=Math.round(b.naturalHeight*c),"zoom"===this.settings.imageScaleMethod?(c=1,e<h?c=h/e:f<k&&(c=k/f),1!==c&&(f=Math.round(f*c),e=Math.round(e*c))):"fit"===this.settings.imageScaleMethod&&(c=1,f>k?c=k/f:e>h&&(c=h/e),1!==c&&(f=Math.round(f*c),e=Math.round(e*c))));c=Math.round((h-e)/2)+"px";k=Math.round((k-f)/2)+"px";a.DOM.setStyle(b,{position:"absolute",width:f,height:e,top:c,left:k,display:"block"})}},setContentLeftPosition:function(){var b,c,f;b=this.settings.target===e?a.DOM.windowWidth():a.DOM.width(this.settings.target);
c=this.getItemEls();f=0;this.settings.loop?f=-1*(b+this.settings.margin):this.currentCacheIndex===this.cache.images.length-1?f=-1*(c.length-1)*(b+this.settings.margin):0<this.currentCacheIndex&&(f=-1*(b+this.settings.margin));a.DOM.setStyle(this.contentEl,{left:f+"px"})},show:function(d){this.currentCacheIndex=d;this.resetPosition();this.setImages(!1);a.DOM.show(this.el);a.Animation.resetTranslate(this.contentEl);d=this.getItemEls();var c,e;c=0;for(e=d.length;c<e;c++)a.Animation.resetTranslate(d[c]);
...
this.imageErrorHandler);d.load()},slideCarousel:function(d,c,f){if(!this.isSliding){var l,k;l=this.settings.target===e?a.DOM.windowWidth()+this.settings.margin:a.DOM.width(this.settings.target)+this.settings.margin;f=a.coalesce(f,this.settings.slideSpeed);if(!(1>e.Math.abs(k))){switch(c){case a.TouchElement.ActionTypes.swipeLeft:d=-1*l;break;case a.TouchElement.ActionTypes.swipeRight:d=l;break;default:k=d.x-this.touchStartPoint.x,d=e.Math.abs(k)>l/2?0<k?l:-1*l:0}this.lastSlideByAction=0>d?b.Carousel.SlideByAction.next:
...
this.isSlideshowActive=!0;this.slideshowTimeout=e.setTimeout(this.slideshowNext.bind(this),this.settings.slideshowDelay);a.Events.fire(this,{type:b.Carousel.EventTypes.onSlideshowStart,target:this})},stopSlideshow:function(){a.isNothing(this.slideshowTimeout)||(e.clearTimeout(this.slideshowTimeout),this.slideshowTimeout=null,this.isSlideshowActive=!1,a.Events.fire(this,{type:b.Carousel.EventTypes.onSlideshowStop,target:this}))},onSlideByEnd:function(d){a.isNothing(this.isSliding)||(d=this.getItemEls(),
...
"",c[a.Animation._transitionPrefix+"TimingFunction"]="",c[a.Animation._transitionPrefix+"Delay"]="0",c[a.Animation._transformLabel]=a.Browser.is3dSupported?"translate3d("+b+"px, 0px, 0px)":"translate("+b+"px, 0px)",a.DOM.setStyle(this.contentEl,c)):a.isNothing(e.jQuery)||e.jQuery(this.contentEl).stop().css("left",this.getStartingPos().x+b+"px")},doSlideCarousel:function(b,c){var f;0>=c?this.slideByEndHandler():a.Browser.isCSSTransformSupported?(f=a.coalesce(this.contentEl.style.webkitTransform,this.contentEl.style.MozTransform,
this.contentEl.style.transform,""),0===f.indexOf("translate3d("+b)?this.slideByEndHandler():0===f.indexOf("translate("+b)?this.slideByEndHandler():a.Animation.slideBy(this.contentEl,b,0,c,this.slideByEndHandler,this.settings.slideTimingFunction)):a.isNothing(e.jQuery)||(f={left:this.getStartingPos().x+b+"px"},"ease-out"===this.settings.animationTimingFunction&&(this.settings.animationTimingFunction="easeOutQuad"),a.isNothing(e.jQuery.easing[this.settings.animationTimingFunction])&&(this.settings.animationTimingFunction=
...
{close:"close",play:"play",next:"next",previous:"previous",none:"none"};b.Toolbar.EventTypes={onTap:"PhotoSwipeToolbarOnClick",onBeforeShow:"PhotoSwipeToolbarOnBeforeShow",onShow:"PhotoSwipeToolbarOnShow",onBeforeHide:"PhotoSwipeToolbarOnBeforeHide",onHide:"PhotoSwipeToolbarOnHide"};b.Toolbar.getToolbar=function(){return'<div class="'+b.Toolbar.CssClasses.play+'"><div class="'+b.Toolbar.CssClasses.toolbarContent+'"></div></div><ul><li class="'+b.Toolbar.CssClasses.previous+'"><span class="'+b.Toolbar.CssClasses.toolbarContent+
'"></span></li><li class="'+b.Toolbar.CssClasses.next+'"><span class="'+b.Toolbar.CssClasses.toolbarContent+'"></span></li></ul>'}})(window,window.klass,window.Code.Util);
...
a.DOM.removeChild(this.toolbarEl,this.toolbarEl.parentNode);a.DOM.removeChild(this.captionEl,this.captionEl.parentNode);for(b in this)a.objectHasProperty(this,b)&&(this[b]=null)},initialize:function(d,c){var f;this.settings=c;this.cache=d;this.isVisible=!1;this.fadeOutHandler=this.onFadeOut.bind(this);this.touchStartHandler=this.onTouchStart.bind(this);this.touchMoveHandler=this.onTouchMove.bind(this);this.clickHandler=this.onClick.bind(this);f=b.Toolbar.CssClasses.toolbar;this.settings.captionAndToolbarFlipPosition&&
(f=f+" "+b.Toolbar.CssClasses.toolbarTop);this.toolbarEl=a.DOM.createElement("div",{"class":f},this.settings.getToolbar());a.DOM.setStyle(this.toolbarEl,{left:0,position:"absolute",overflow:"hidden",zIndex:this.settings.zIndex});this.settings.target===e?a.DOM.appendToBody(this.toolbarEl):a.DOM.appendChild(this.toolbarEl,this.settings.target);a.DOM.hide(this.toolbarEl);this.settings.preventHide&&!a.isNothing(this.closeEl)&&a.DOM.hide(this.closeEl);this.playEl=a.DOM.find("."+b.Toolbar.CssClasses.play,
this.toolbarEl)[0];this.settings.preventSlideshow&&!a.isNothing(this.playEl)&&a.DOM.hide(this.playEl);this.nextEl=a.DOM.find("."+b.Toolbar.CssClasses.next,this.toolbarEl)[0];this.previousEl=a.DOM.find("."+b.Toolbar.CssClasses.previous,this.toolbarEl)[0];f=b.Toolbar.CssClasses.caption;this.settings.captionAndToolbarFlipPosition&&(f=f+" "+b.Toolbar.CssClasses.captionBottom);this.captionEl=a.DOM.createElement("div",{"class":f},"");a.DOM.setStyle(this.captionEl,{left:0,position:"absolute",overflow:"hidden",
zIndex:this.settings.zIndex});this.settings.target===e?a.DOM.appendToBody(this.captionEl):a.DOM.appendChild(this.captionEl,this.settings.target);a.DOM.hide(this.captionEl);this.captionContentEl=a.DOM.createElement("div",{"class":b.Toolbar.CssClasses.captionContent},"");this.closeEl=a.DOM.createElement("div",{"class":b.Toolbar.CssClasses.close},"");this.closeEl.innerHTML='<div class="'+b.Toolbar.CssClasses.close+'"><span>&#121;</span></span></span></div>';a.DOM.appendChild(this.captionContentEl,this.captionEl);
a.DOM.appendChild(this.closeEl,this.captionEl);this.addEventHandlers()},resetPosition:function(){var b,c,f;this.settings.target===e?(this.settings.captionAndToolbarFlipPosition?(c=a.DOM.windowScrollTop(),f=a.DOM.windowScrollTop()+a.DOM.windowHeight()-a.DOM.height(this.captionEl)):(c=a.DOM.windowScrollTop()+a.DOM.windowHeight()-a.DOM.height(this.toolbarEl),f=a.DOM.windowScrollTop()),b=a.DOM.windowWidth()):(this.settings.captionAndToolbarFlipPosition?(c="0",f=a.DOM.height(this.settings.target)-a.DOM.height(this.captionEl)):
(c=a.DOM.height(this.settings.target)-a.DOM.height(this.toolbarEl),f=0),b=a.DOM.width(this.settings.target));a.DOM.setStyle(this.toolbarEl,{top:c+"px",width:b});a.DOM.setStyle(this.captionEl,{top:f+"px",width:b})},toggleVisibility:function(a){this.isVisible?this.fadeOut():this.show(a)},show:function(d){a.Animation.stop(this.toolbarEl);a.Animation.stop(this.captionEl);this.resetPosition();this.setToolbarStatus(d);a.Events.fire(this,{type:b.Toolbar.EventTypes.onBeforeShow,target:this});this.showToolbar();
this.setCaption(d);this.showCaption();this.isVisible=!0;this.setTimeout();a.Events.fire(this,{type:b.Toolbar.EventTypes.onShow,target:this})},setTimeout:function(){0<this.settings.captionAndToolbarAutoHideDelay&&(this.clearTimeout(),this.timeout=e.setTimeout(this.fadeOut.bind(this),this.settings.captionAndToolbarAutoHideDelay))},clearTimeout:function(){a.isNothing(this.timeout)||(e.clearTimeout(this.timeout),this.timeout=null)},fadeOut:function(){this.clearTimeout();a.Events.fire(this,{type:b.Toolbar.EventTypes.onBeforeHide,
target:this});a.Animation.fadeOut(this.toolbarEl,this.settings.fadeOutSpeed);a.Animation.fadeOut(this.captionEl,this.settings.fadeOutSpeed,this.fadeOutHandler);this.isVisible=!1},addEventHandlers:function(){a.Browser.isTouchSupported&&(a.Browser.blackberry||a.Events.add(this.toolbarEl,"touchstart",this.touchStartHandler),a.Events.add(this.toolbarEl,"touchmove",this.touchMoveHandler),a.Events.add(this.captionEl,"touchmove",this.touchMoveHandler));a.Events.add(this.toolbarEl,"click",this.clickHandler);
a.Events.add(this.captionEl,"click",this.clickHandler)},removeEventHandlers:function(){a.Browser.isTouchSupported&&(a.Browser.blackberry||a.Events.remove(this.toolbarEl,"touchstart",this.touchStartHandler),a.Events.remove(this.toolbarEl,"touchmove",this.touchMoveHandler),a.Events.remove(this.captionEl,"touchmove",this.touchMoveHandler));a.Events.remove(this.toolbarEl,"click",this.clickHandler)},handleTap:function(d){this.clearTimeout();var c;if(d.target===this.nextEl||a.DOM.isChildOf(d.target,this.nextEl))c=
b.Toolbar.ToolbarAction.next;else if(d.target===this.previousEl||a.DOM.isChildOf(d.target,this.previousEl))c=b.Toolbar.ToolbarAction.previous;else if(d.target===this.closeEl||a.DOM.isChildOf(d.target,this.closeEl))c=b.Toolbar.ToolbarAction.close;else if(d.target===this.playEl||a.DOM.isChildOf(d.target,this.playEl))c=b.Toolbar.ToolbarAction.play;this.setTimeout();a.isNothing(c)&&(c=b.Toolbar.ToolbarAction.none);a.Events.fire(this,{type:b.Toolbar.EventTypes.onTap,target:this,action:c,tapTarget:d.target})},
setCaption:function(b){a.DOM.removeChildren(this.captionContentEl);this.currentCaption=a.coalesce(this.cache.images[b].caption,"\u00a0");a.isObject(this.currentCaption)?a.DOM.appendChild(this.currentCaption,this.captionContentEl):(""===this.currentCaption&&(this.currentCaption="\u00a0"),a.DOM.appendText(this.currentCaption,this.captionContentEl));this.currentCaption="\u00a0"===this.currentCaption?"":this.currentCaption;this.resetPosition()},showToolbar:function(){a.DOM.setStyle(this.toolbarEl,{opacity:this.settings.captionAndToolbarOpacity});
a.DOM.show(this.toolbarEl)},showCaption:function(){(""===this.currentCaption||1>this.captionContentEl.childNodes.length)&&!this.settings.captionAndToolbarShowEmptyCaptions?a.DOM.hide(this.captionEl):(a.DOM.setStyle(this.captionEl,{opacity:this.settings.captionAndToolbarOpacity}),a.DOM.show(this.captionEl))},setToolbarStatus:function(d){this.settings.loop||(a.DOM.removeClass(this.previousEl,b.Toolbar.CssClasses.previousDisabled),a.DOM.removeClass(this.nextEl,b.Toolbar.CssClasses.nextDisabled),0<d&&
d<this.cache.images.length-1||(0===d&&(a.isNothing(this.previousEl)||a.DOM.addClass(this.previousEl,b.Toolbar.CssClasses.previousDisabled)),d===this.cache.images.length-1&&(a.isNothing(this.nextEl)||a.DOM.addClass(this.nextEl,b.Toolbar.CssClasses.nextDisabled))))},onFadeOut:function(){a.DOM.hide(this.toolbarEl);a.DOM.hide(this.captionEl);a.Events.fire(this,{type:b.Toolbar.EventTypes.onHide,target:this})},onTouchStart:function(b){b.preventDefault();a.Events.remove(this.toolbarEl,"click",this.clickHandler);
...
(function(e,c,a){a.registerNamespace("Code.PhotoSwipe.ZoomPanRotate");var b=e.Code.PhotoSwipe;b.ZoomPanRotate.ZoomPanRotateClass=c({el:null,settings:null,containerEl:null,imageEl:null,transformSettings:null,panStartingPoint:null,transformEl:null,dispose:function(){var b;a.DOM.removeChild(this.el,this.el.parentNode);for(b in this)a.objectHasProperty(this,b)&&(this[b]=null)},initialize:function(c,g,f){var l,k,h;this.settings=c;this.settings.target===e?(c=document.body,l=a.DOM.windowWidth(),k=a.DOM.windowHeight(),
h=a.DOM.windowScrollTop()+"px"):(c=this.settings.target,l=a.DOM.width(c),k=a.DOM.height(c),h="0px");this.imageEl=g.imageEl.cloneNode(!1);a.DOM.setStyle(this.imageEl,{zIndex:1});this.transformSettings={startingScale:1,scale:1,startingRotation:0,rotation:0,startingTranslateX:0,startingTranslateY:0,translateX:0,translateY:0};this.el=a.DOM.createElement("div",{"class":b.ZoomPanRotate.CssClasses.zoomPanRotate},"");a.DOM.setStyle(this.el,{left:0,top:h,position:"absolute",width:l,height:k,zIndex:this.settings.zIndex,
display:"block"});a.DOM.insertBefore(this.el,f.el,c);a.Browser.iOS?(this.containerEl=a.DOM.createElement("div","",""),a.DOM.setStyle(this.containerEl,{left:0,top:0,width:l,height:k,position:"absolute",zIndex:1}),a.DOM.appendChild(this.imageEl,this.containerEl),a.DOM.appendChild(this.containerEl,this.el),a.Animation.resetTranslate(this.containerEl),a.Animation.resetTranslate(this.imageEl),this.transformEl=this.containerEl):(a.DOM.appendChild(this.imageEl,this.el),this.transformEl=this.imageEl)},setStartingTranslateFromCurrentTransform:function(){var b=
...
a.instances=[];a.activeInstances=[];a.setActivateInstance=function(b){if(-1<c.arrayIndexOf(b.settings.target,a.activeInstances,"target"))throw"Code.PhotoSwipe.activateInstance: Unable to active instance as another instance is already active for this target";a.activeInstances.push({target:b.settings.target,instance:b})};a.unsetActivateInstance=function(b){b=c.arrayIndexOf(b,a.activeInstances,"instance");a.activeInstances.splice(b,1)};a.attach=function(b,d,e){var f,l;f=a.createInstance(b,d,e);d=0;for(e=
b.length;d<e;d++)l=b[d],c.isNothing(l.nodeType)||1!==l.nodeType||(l.__photoSwipeClickHandler=a.onTriggerElementClick.bind(f),c.Events.remove(l,"click",l.__photoSwipeClickHandler),c.Events.add(l,"click",l.__photoSwipeClickHandler));return f};e.jQuery&&(e.jQuery.fn.photoSwipe=function(b,c){return a.attach(this,b,c)});a.detatch=function(b){var d,e,f;d=0;for(e=b.originalImages.length;d<e;d++)f=b.originalImages[d],c.isNothing(f.nodeType)||1!==f.nodeType||(c.Events.remove(f,"click",f.__photoSwipeClickHandler),
delete f.__photoSwipeClickHandler);a.disposeInstance(b)};a.createInstance=function(b,d,e){var f;if(c.isNothing(b))throw"Code.PhotoSwipe.attach: No images passed.";if(!c.isLikeArray(b))throw"Code.PhotoSwipe.createInstance: Images must be an array of elements or image urls.";if(1>b.length)throw"Code.PhotoSwipe.createInstance: No images to passed.";d=c.coalesce(d,{});f=a.getInstance(e);if(c.isNothing(f))f=new a.PhotoSwipeClass(b,d,e),a.instances.push(f);else throw'Code.PhotoSwipe.createInstance: Instance with id "'+
e+' already exists."';return f};a.disposeInstance=function(b){var c=a.getInstanceIndex(b);if(0>c)throw"Code.PhotoSwipe.disposeInstance: Unable to find instance to dispose.";b.dispose();a.instances.splice(c,1)};a.onTriggerElementClick=function(a){a.preventDefault();this.show(a.currentTarget)};a.getInstance=function(b){var c,e,f;c=0;for(e=a.instances.length;c<e;c++)if(f=a.instances[c],f.id===b)return f;return null};a.getInstanceIndex=function(b){var c,e,f=-1;c=0;for(e=a.instances.length;c<e;c++)if(a.instances[c]===
b){f=c;break}return f}})(window,window.Code.Util);
(function(e,c,a,b,d,g,f,l,k){a.registerNamespace("Code.PhotoSwipe");var h=e.Code.PhotoSwipe;h.PhotoSwipeClass=c({id:null,settings:null,isBackEventSupported:null,backButtonClicked:null,currentIndex:null,originalImages:null,mouseWheelStartTime:null,windowDimensions:null,cache:null,documentOverlay:null,carousel:null,uiLayer:null,toolbar:null,zoomPanRotate:null,windowOrientationChangeHandler:null,windowScrollHandler:null,windowHashChangeHandler:null,keyDownHandler:null,windowOrientationEventName:null,
