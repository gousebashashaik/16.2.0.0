define("tui/searchBPanel/view/AdultsSelectOption", [
	"dojo",
	"tui/searchBPanel/view/PartyCompSelectOption"], function (dojo) {

	dojo.declare("tui.searchBPanel.view.AdultsSelectOption", [tui.searchBPanel.view.PartyCompSelectOption], {
	...
	return tui.searchBPanel.view.AdultsSelectOption;
});