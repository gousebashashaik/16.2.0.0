define("tui/searchBPanel/view/SearchGuide", [
	"dojo",
	"dojo/on",
	'dojo/_base/fx',
	'dojo/fx',
	...
	dojo.declare("tui.searchBPanel.view.SearchGuide", [tui.widget.expand.SimpleExpandable, tui.searchB.nls.Searchi18nable], {
	...
	return tui.searchBPanel.view.SearchGuide;
}); 
