define("tui/searchBPanel/view/FlexibleView", [
	"dojo",
	"dojo/on",
	...
	dojo.declare("tui.searchBPanel.view.FlexibleView", [tui.widget._TuiBaseWidget], {
	...
	return tui.searchBPanel.view.FlexibleView;
});
