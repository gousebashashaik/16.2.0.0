define("tui/searchBPanel/view/SubmitButton", [
  "dojo",
  "dojo/on",
  "dojo/has",
  ...
  dojo.declare("tui.searchBPanel.view.SubmitButton", [tui.widget._TuiBaseWidget, tui.searchB.nls.Searchi18nable], {
    ...
    populateSearchForm: function (searchCriteria) {
      ...
      // Add for Latest Deals component for cross brands 
      if (submitButton.widgetController.jsonData) {
	      if(_.has(submitButton.widgetController.jsonData.searchRequestData, "brandType")) {
	          submitButton.createInput("brandType", submitButton.widgetController.jsonData.searchRequestData.brandType);
	        }
	  }
  ...
  return tui.searchBPanel.view.SubmitButton;
});
