define("tui/searchBPanel/view/AirportGuide", [
    "dojo",
    "dojo/on",
    "dojo/_base/lang",
    "dojo/_base/connect",
    "dojo/has",
    "dojo/dom-attr",
    "dojo/text!tui/searchBPanel/view/templates/AirportGuideTmpl.html",
    ...
    function (dojo, on, lang, connect, has, domAttr, airportGuideTmpl, AirportModel) {

        dojo.declare("tui.searchBPanel.view.AirportGuide", [tui.searchBPanel.view.SearchGuide,
                                                            tui.searchBPanel.view.SearchErrorMessaging], {
            ...
            postCreate: function () {
                ...
                resultSet.observe(function (airportModel, remove, add) {
                	var totalAirportSelected = airportGuide.searchPanelModel.from.query().length;
                	if(totalAirportSelected){
                		 if (totalAirportSelected === 1){
                             airportGuide.placeholder.innerHTML = airportGuide.searchPanelModel.from.query()[0].name;
                     }else{
                			 airportGuide.placeholder.innerHTML = airportGuide.searchPanelModel.from.query()[0].name + " +" + (totalAirportSelected - 1) +" More";
                		 }
                     }
            ...
            attachOpenEvent: function () {
                ...
                on(airportGuide.domNode, "click", function (event) {
                    ...
                    if (airportGuide.expandableDom === null || !airportGuide.isShowing(airportGuide.expandableDom)) {
                        dojo.publish("tui.searchBPanel.view.DestinationGuide.closeExpandable");
                        setTimeout(function () {
                            airportGuide.openExpandable();
                        }, 350);
                    } else {
            ...
            onAfterTmplRender: function () {
                ...
                on(airportGuide.expandableDom, "label:click", function (event) {
                    ...
                    dojo.publish("tui.searchBPanel.view.AirportMultiFieldList.pulse", [airportGuide.widgetController]);
                ...
                airportGuide.subscribe("tui/searchBPanel/searchOpening", function (component) {
            ...
            openExpandable: function () {
              ...
              //applying left border on open of airport guide
                ...
                dojo.publish("tui.searchBPanel.view.AirportMultiFieldList.highlight", [true, airportGuide.widgetController]);
            ...
            closeExpandable: function () {
              ...
              //removing left border on close of airport guide
                ...
                dojo.publish("tui.searchBPanel.view.AirportMultiFieldList.highlight", [false, airportGuide.widgetController]);
            ...
            showWidget: function (element) {
                ...
                if(airportGuide.widgetController.searchApi === "getPrice") {
                    ...
                    dojo.publish("tui.searchBGetPrice.view.GetPriceModal.resize", 777);
            ...
            hideWidget: function (element) {
                ...
                if(airportGuide.widgetController.searchApi === "getPrice") {
                    // TODO: fix width being sent, this is arbitrary
                    dojo.publish("tui.searchBGetPrice.view.GetPriceModal.resize", 358);
                    // ie7 has issues with getPrice guide
                    // TODO: fix this at some point
            ...
            updateGuideCount: function () {
                ...
                totalAirportSelected = airportGuide.searchPanelModel.from.query().length;
            	if(totalAirportSelected){
            		 if (totalAirportSelected === 1){
                         airportGuide.placeholder.innerHTML = airportGuide.searchPanelModel.from.query()[0].name;
                }else{
                  ...
                  if (airportGuide.widgetController.searchApi === "searchPanel") {
                     airportGuide.placeholder.innerHTML = airportGuide.searchMessaging[dojoConfig.site].from.placeholder;
                }else{
                  airportGuide.placeholder.innerHTML = airportGuide.searchMessaging[dojoConfig.site].from.getPricePlaceholder;
                  }
                }
        ...
        return tui.searchBPanel.view.AirportGuide;
    });
