define("tui/searchBPanel/view/SearchDatePicker", [
  "dojo",
  "dojo/store/Observable",
  "dojo/dom-attr",
  "dojo/text!tui/searchBPanel/view/templates/searchDatepicker.html",
  "tui/searchBPanel/store/DateStore",
  "dojo/string",
  ...
  dojo.declare("tui.searchBPanel.view.SearchDatePicker", [tui.widget.datepicker.DatePicker, tui.searchB.nls.Searchi18nable, tui.searchBPanel.view.SearchErrorMessaging], {
    ...
    postCreate: function () {
      ...
      searchDatePicker.seasonLength = searchDatePicker.seasonLength;
      ...
      dojo.subscribe("tui/searchBPanel/view/AutoComplete/datePicker", function () {
        searchDatePicker.setFieldValue(searchDatePicker.searchMessaging.date.placeholder);
        searchDatePicker.onCalendarFocus();
      });

      dojo.subscribe("tui/searchBPanel/searchOpening", function (component) {
  ...
  return tui.searchBPanel.view.SearchDatePicker;
});
