define("tui/searchBPanel/view/SearchAutoComplete", [
	"dojo",
	"tui/widget/form/AutoComplete"], function (dojo) {

	dojo.declare("tui.searchBPanel.view.SearchAutoComplete", [tui.widget.form.AutoComplete], {
		...
		postCreate: function () {
			...
			searchAutoComplete.subscribe("tui/searchBPanel/searchOpening", function (component) {
	...
	return tui.searchBPanel.view.SearchAutoComplete;
});
