define("tui/searchBPanel/view/SearchErrorMessaging", [
  "dojo",
  "tui/searchBPanel/view/ErrorPopup"], function (dojo, ErrorPopup) {

  dojo.declare("tui.searchBPanel.view.SearchErrorMessaging", null, {
  ...
  return tui.searchBPanel.view.SearchErrorMessaging;
});