define("tui/searchBPanel/view/ChildSelectOption", [
  "dojo",
  "dojo/text!tui/searchBPanel/view/templates/ChildAgeSelectOption.html",
  "tui/widget/mixins/Templatable",
  "tui/searchBPanel/view/PartyCompSelectOption",
  "tui/searchBPanel/view/ChildAgesView"], function (dojo, childAgeSelectorTmpl, Templatable, SelectOption, ChildAgesView) {

  dojo.declare("tui.searchBPanel.view.ChildSelectOption", [tui.searchBPanel.view.PartyCompSelectOption, tui.widget.mixins.Templatable, tui.searchB.nls.Searchi18nable], {
    ...
    addChildAgeSelector: function (name, oldChildAges, newChildAges) {
      ...
      var childAgesHtml = childSelectOption.renderTmpl(childAgeSelectorTmpl, childSelectOption);
      ...
      if(childSelectOption.widgetController.searchApi === 'getPrice'){
    	  dojo.publish("tui.searchBGetPrice.view.GetPriceModal.positionPopUp");
      }
    },
  ...
  return tui.searchBPanel.view.ChildSelectOption;
});
