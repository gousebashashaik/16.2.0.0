define("tui/searchBPanel/store/DateStore", [
  "dojo",
  "dojo/io-query",
  ...
  dojo.declare("tui.searchBPanel.store.DateStore", [tui.search.store.SearchPanelMemory], {
  ...
  return tui.searchBPanel.store.DateStore;
});
