define("tui/searchBPanel/store/AirportMultiFieldStore", [
    "dojo",
    'tui/searchPanel/config/SearchConfig',
    "tui/searchBPanel/store/SearchMultiFieldStore"
], function (dojo, searchConfig) {

    dojo.declare("tui.searchBPanel.store.AirportMultiFieldStore", [tui.searchBPanel.store.SearchMultiFieldStore], {
        ...
        put: function (object, options) {
            ...
            if (!object.isInstanceOf(tui.searchBPanel.model.AirportModel)) {
                throw "Object needs to be an instance of tui.searchBPanel.model.AirportModel";
            }
    ...
    return tui.searchBPanel.store.AirportMultiFieldStore;
});
