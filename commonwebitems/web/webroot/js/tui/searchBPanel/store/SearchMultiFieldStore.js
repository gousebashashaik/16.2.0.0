define("tui/searchBPanel/store/SearchMultiFieldStore", [
	"dojo",
	"dojo/store/Memory"], function (dojo) {

	dojo.declare("tui.searchBPanel.store.SearchMultiFieldStore", [dojo.store.Memory], {
    ...
    emptyStore: function () {
      ...
      _.each(data, function (dataItem) {
		...
		return tui.searchBPanel.store.SearchMultiFieldStore;
});
