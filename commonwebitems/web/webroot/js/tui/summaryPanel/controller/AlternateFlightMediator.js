define("tui/summaryPanel/controller/AlternateFlightMediator", [
    "dojo",
    "dojo/dom",
    "dojo/_base/xhr",
    ...
    "dojo/dom-construct",
    "dojo/topic",
    "tui/widget/booking/flightoptions/FlightOptionsMediator"], function (dojo, dom, xhr, sessionStore,BookflowUrl, connect,ErrorView,ErrorOverlay,domConstruct,topic) {

    var TARGET_URL = dojoConfig.paths.webRoot+ "/ws/alternateFlights";
    ...
    dojo.declare("tui.summaryPanel.controller.AlternateFlightMediator", [tui.widget.booking.flightoptions.FlightOptionsMediator], {

        controllers: [],

        targetUrl: dojoConfig.paths.webRoot+ "/ws/alternateFlights",
        ...
        beforeRequest: function () {
            var mediator = this;
            var resultsNode = dojo.query(".search-results")[1];
            if(resultsNode){
        ...
        afterFailure: function (html,statusCode) {
            var mediator = this;
            dojo.removeClass(dojo.query(".search-results")[1], 'updating');
            mediator.doAjaxRequest = true;
        ...
        fire: function (duration, departureAirportCode,selectedFilters, selectedDate, packageId) {
            ...
            doWhen(mediator.doAjaxRequest, function () {
                ...
                var requestData= dijit.registry.byId('tui_summaryPanel_view_FlightSummary_0').data.requestData;//mediator.data1.requestData;
                ...
                var searchCriteriaJsonData= requestData;
                var searchCriteriaJsonString = dojo.toJson(searchCriteriaJsonData);

				var request ={altFlightSearchCriteria:jsonString,searchRequest:searchCriteriaJsonString};
                */
                //var requestData=mediator.data.requestData;
                var jsonData= {
                		    "selectedDuration":duration,
                		    "selectedDepartureAirportCode":departureAirportCode,
                		    "selectedFilters":selectedFilters,
                ...
                /*if(packageId === null){
                    mediator.latestRequest = jsonData;
                }else{
                    mediator.latestRequest.packageId = packageId;
                    jsonData = mediator.latestRequest;
                }*/
                ...
                dojo.when(results, function (response) {
                	if( response.packageSoldOut ){
                		mediator.afterFailure("", 500);
                		return;
                	}
    ...
    return tui.summaryPanel.controller.AlternateFlightMediator;
});