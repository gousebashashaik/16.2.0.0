            ...
            _leaveTransforms: function (el) {
                ...
                window.setTimeout(function () {
                    ...
                    if (!Util.isNothing(transformExploded)) {
                        ...
                        if (el.classList.contains('ps-carousel-content')) {
                            Util.DOM.setStyle(el, style);
                        }
...
(function (window, klass, Util) {
    ...
    PhotoSwipe.Toolbar.getToolbar = function () {
        ...
        return '<div class="' + PhotoSwipe.Toolbar.CssClasses.play + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div>' +

            '<ul><li class="' + PhotoSwipe.Toolbar.CssClasses.previous + '"><span class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></span></li><li class="' + PhotoSwipe.Toolbar.CssClasses.next + '"><span class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></span></li></ul>';
...
(function (window, klass, Util) {
    ...
    PhotoSwipe.Toolbar.ToolbarClass = klass({
        ...
        initialize: function (cache, options) {
            ...
            this.closeEl = Util.DOM.createElement(
                'div',
                {
            ...
            this.closeEl.innerHTML = '<div class="' + PhotoSwipe.Toolbar.CssClasses.close + '"><span>&#121;</span></span></span></div>';

            Util.DOM.appendChild(this.captionContentEl, this.captionEl);
            Util.DOM.appendChild(this.closeEl, this.captionEl);
        ...
        addEventHandlers: function () {
            ...
            Util.Events.add(this.captionEl, 'click', this.clickHandler);
